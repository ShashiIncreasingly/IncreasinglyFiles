...
var csshidel = '.d_none_md_inc .mfp-wrap.mfp-zoom-in.mfp-ready{display:none;opacity: 0;} .inc_open_sidebar .mfp-wrap.mfp-zoom-in.mfp-ready{display:none;opacity: 0;}'
var css_inc = document.createElement('style'); 
css_inc.type = 'text/css'; 
css_inc.innerHTML=csshidel
var checktickboxadd=false;
...
if (INC_collection_load == true) {
    ...
    function showSidebar() {
        try{
            ...
            if(document.querySelector('.mfp-close') != null && document.querySelector(".inc_sidebar_modal_block") != null){
                if(document.querySelector('.mfp-close') != null){
            ...
            setTimeout(function(){
                document.querySelector('html').classList.remove('d_none_md_inc')
            },2500)
        }
        catch(er){
            document.querySelector('html').classList.remove('d_none_md_inc')
    ...
    function getProductSizesObj(findObj) {
        ...
        var sizesArray = ["XS","S", "M", "L", "XL", "XX", "XXL", "2XL", "3XL", "4XL", "5XL"];
    ...
    function addBundleToCart() {
        ...
        bundleCartProductsArray.forEach(function (productSKU) {
            ...
            if(bundleCartProductsArray.length == checkcount){
                setTimeout(function(){
                    updateminicartinc()
                },2000)
            }
    ...
    function init() {
        setTimeout(function(){
            if(document.querySelector('#CartCount') != null){
                var countcrt_1=document.querySelector('#CartCount').innerText
                clientproductc = countcrt_1
            }
        },1000)
        addIncVisitorId();
    ...
    function clickListener(e) {
        ...
        if(document.querySelector('#CartCount') != null){
            var countcrt=document.querySelector('#CartCount').innerText
            if(countcrt != "" && countcrt != 0){
                if(parseInt(clientproductc) < parseInt(countcrt)){
                    checkqtyflg = true
                    clientproductc = countcrt
                }
            }
        }else if(document.querySelectorAll('.mini-products-list li.fl')[0] != undefined){
            var elccount=document.querySelectorAll('.mini-products-list li.fl').length
            if(elccount != "" && elccount != 0){
                if(parseInt(clientproductc) < parseInt(elccount)){
                    checkqtyflg = true
                    clientproductc = elccount
                }
            }
        }
        if(clientproductc == 0){
        ...
        setTimeout(function(){
            if(document.querySelector('#CartCount') != null){
                var countcrt_=document.querySelector('#CartCount').innerText
                clientproductc = countcrt_
            }
        },1000)
        if(clickedElement.parentNode != null){
            if (inc.pageType == "pdp") {
                if(clickedElement.classList.contains('product-form__cart-submit') == true || clickedElement.parentNode.classList.contains('product-form__cart-submit') == true ||( clickedElement.className == 'hdicon header-cart' && document.querySelector('.mfp-wrap.mfp-zoom-in') != null && checkqtyflg == true)){
                    if(checktickboxadd == false && document.querySelector('.inc_sidebar_modal_block[style="display: block;"]') == null){
                        console.log("tickbox called")
                        document.querySelector('html').classList.add('d_none_md_inc')
        ...
        if (clickedElement.className !== "inc_product_att_sel_done_btn_block" && clickedElement.className !== "inc_product_desc_att_color_img"
            ...
            && clickedElement.className !== "" && clickedElement.className != "inc_product_desc_add_img"  && clickedElement.className != "inc_product_desc_add_img" && clickedElement.className != "inc_product_desc_add_block" && clickedElement.className != "inc_product_desc_add_img_block") {
                document.querySelectorAll('.inc_product_att_sel_block[style="display: block;"]').forEach(function (element) {
                     element.style.display = "none"; element.classList.remove('btn_disable_mode') 
                    if( document.querySelector('.inc_product_block.show_overlay') != null){
                        document.querySelector('.inc_product_block.show_overlay').classList.remove('show_overlay')
                    }
                })
...
function pdptickboxblock(){
    ...
    eltickboxblock.style.marginBottom = "10px"
    ...
    if(loadbundles == true){
        if(eltickplacement != null){
            var eltickboxplcment = eltickplacement.parentNode
            eltickboxplcment.parentNode.insertBefore(eltickboxblock,eltickboxplcment)
        }
    }
    ...
    var elclientcta = document.querySelector('button.product-form__cart-submit span')
    // elclientcta.setAttribute('onClick', 'inctickboxadd(this)');
    setTimeout(function(){
        onloadflag = false
    },3000)
}
function inctickboxadd(elm){
    console.log("fn called")
}
function addtickboxToCart() {
    checktickboxadd = true
    var reqURL = 'https://uspoloassn.com/cart/add.js';
    ...
    tickboxProductsArray.forEach(function (productSKU) {
        ...
        if(tickboxProductsArray.length == checkcountch){
            setTimeout(function(){
                updateminicartinc()
            },2000)
        }
