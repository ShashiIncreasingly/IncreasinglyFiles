...
(function(){
    ...
    if (window.location.hostname == 'tt311.w2solution.com'){
        ...
        INC.clientConfig.checkoutLink = "https://www.e-hapi.com/shop/cart/cart.aspx";
    }
    ...
    INC.methods.createAMBlock = function (PDP_type) {
        if (INC.dataStore.dataStoreObj.undefined == undefined) {
            ...
            if (PDP_type == "PDP") {
                ...
                if (bundleProductsArray.length > 0){
                    if (document.querySelector('.karte-widget .karte-widget__content').innerHTML != '' && document.querySelector('.karte-widget .karte-widget__content ul').innerHTML !== "" &&  document.querySelector('.karte-widget .karte-widget__content section').style.display != 'none'){
        ...
        if (Object.keys(productObj).length != 0) {
            ...
            if (blockType == "pdp") {
                if(document.querySelector('.inc_img_together_block .inc_main_img_block img') != null &&  document.querySelector('.inc_goes_img_block img') != null){
                    ...
                    if (window.location.hostname == 'tt311.w2solution.com'){
                        var href_2 = document.querySelector('.inc_pdp_bundle_product_list_main_block .inc_product_module_block .inc_product_img_block a').href.replace('https://cefinecosmetics.co.jp/','https://tt311.w2solution.com/Test/R1024_Cefine/');
                    } else {
