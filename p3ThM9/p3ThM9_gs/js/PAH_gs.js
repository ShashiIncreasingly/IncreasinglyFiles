...
setTimeout(function(){
    ...
    var jsFilePath1 = "https://www.increasingly.co/Implementation/p3ThM9/p3ThM9_gs/js/p3ThM9_side_org.js?v=" + versionUpdate1;
...
INC_COL.dataStore.methods = function () {
    ...
    function getProductColorsObj(findObj, type_of) {
                                    ...
                                    if (type_of != undefined) {
                                        ...
                                        if (opt_text != "" && opt_size_text != "" && productListObj[mainProductId][childProductId].option[1] != undefined && productListObj[mainProductId][childProductId].option[2] != undefined) {
                                            if (productListObj[mainProductId][childProductId].option[1].text == opt_text && productListObj[mainProductId][childProductId].option[2].text == opt_size_text) {
                                                ...
                                                productColorArrayObj[productListObj[mainProductId][childProductId]["option"]["0"]["text"]]["qty_v"] = productListObj[mainProductId][childProductId]["option"]["0"]["qty_v"];
                                            }
        ...
        Object.keys(productColorArrayObj).forEach(function (colorText) {
            ...
            colorObj["qty_v"] = productColorArrayObj[colorText]["qty_v"];
    ...
    function getProductSizesObj(findObj, type_of) {
                                        ...
                                        if (productListObj[mainProductId][childProductId].option[1].text == opt_text) {
                                            ...
                                            if (productListObj[mainProductId][childProductId]["option"] != null && productListObj[mainProductId][childProductId]["option"]["2"] != null) {
                                              productSizesArrayObj[productListObj[mainProductId][childProductId]["option"]["2"]["text"]] = {};
                                                ...
                                                productSizesArrayObj[productListObj[mainProductId][childProductId]["option"]["2"]["text"]]["qty_v"] = productListObj[mainProductId][childProductId]["option"]["2"]["qty_v"];
        ...
        Object.keys(productSizesArrayObj).forEach(function (sizeText) {
            ...
            sizeObj["prc"] = prc;
            sizeObj["qty_v"] = productSizesArrayObj[sizeText]["qty_v"];
            sizeObj["label"] = label;
    ...
    function getProductopt0Obj(findObj, type_of) {
                    ...
                    for (childProductId in productListObj[mainProductId]) {
                        ...
                        if (productListObj[mainProductId][childProductId]["option"] != null &&
                            ...
                            if (attr_main == true) {
                                ...
                                product0ArrayObj[productListObj[mainProductId][childProductId]["option"]["1"]["text"]]["qty_v"] = productListObj[mainProductId][childProductId]["option"]["1"]["qty_v"];
                            } else {
        ...
        Object.keys(product0ArrayObj).forEach(function (colorText) {
            ...
            attr0Obj["qty_v"] = product0ArrayObj[colorText]["qty_v"];
...
INC_COL.classes.ProductObj = function (product) {
    ...
    if(product["ProductId"] == "P70833" || product["ProductId"] == "P70834"){
        this.qty = 99999
        //product["Quantity"]
    }else{
...
INC_COL.classes.ProductAttObj = function (product) {
    ...
    if (((product != null) && (product != undefined))) {
        ...
        if(product["childProductId"] == "P70833" || product["childProductId"] == "P70834" || product["childProductId"] == "7142645"){
            this.option[product["optionId"]].qty_v = 99999
        }else{
            this.option[product["optionId"]].qty_v = product["Quantity"]
        }
    }
...
INC_COL.methods.createPDPCollectionBlock = function (sidebar) {
    ...
    if (INC_COL.dataStore.dataStoreObj.undefined != undefined || empty_sidebarflag == false) {
        ...
        if(mainproductb.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
            if(mainproductb.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"] .inc_prd_desc_att_color_list_item_img') != null){
                mainproductb.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"] .inc_prd_desc_att_color_list_item_img').click()
            }
        } else{
            if(mainproductb.querySelector('.inc_prd_desc_att_color_list_item_img_bk[stock="instock"]') != null){
                mainproductb.querySelector('.inc_prd_desc_att_color_list_item_img_bk[stock="instock"]').click()
            }
        }
        if(mainproductb.querySelector('.inc_prd_desc_att_zero_bk.inc_active') != null){
            if(mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail') != null){
                if(mainproductb.querySelector('.inc_prd_desc_att_zero_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                    mainproductb.querySelector('.inc_prd_desc_att_zero_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                }else{
                    if(mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail[stock="instock"]') != null){
                        mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk[stock="instock"]').click()
                    }
                }
            }
        } 
        ...
        if(mainproductb.querySelector('.inc_prd_desc_att_size_bk.inc_active') != null){
            if(mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail') != null){
                if(mainproductb.querySelector('.inc_prd_desc_att_size_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                    mainproductb.querySelector('.inc_prd_desc_att_size_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                }else{
                    if(mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail[stock="instock"]') != null){
                        mainproductb.querySelector('.inc_prd_desc_att_size_list_item_img_bk[stock="instock"]').click()
                    }
        ...
        if(mainproductb.querySelector('.inc_prd_desc_att_third_bk.inc_active') != null){
            if(mainproductb.querySelector('.inc_prd_desc_att_third_list_item_img_bk.avail') != null){
                if(mainproductb.querySelector('.inc_prd_desc_att_third_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                    mainproductb.querySelector('.inc_prd_desc_att_third_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                }else{
                    if(mainproductb.querySelector('.inc_prd_desc_att_third_list_item_img_bk.avail[stock="instock"]') != null){
                        mainproductb.querySelector('.inc_prd_desc_att_third_list_item_img_bk[stock="instock"]').click()
                    }
                }
            }
        } 
            ...
            for (var i = 0; i < 7; i++) {
                if(i == 0 || i == 2 || i == 4 || i == 6){
                    if(elProductAddBlock[i] != undefined){
                        ...
                        if(elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                            if(elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"] .inc_prd_desc_att_color_list_item_img') != null){
                                elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"][stock="instock"] .inc_prd_desc_att_color_list_item_img').click()
                            }
                        } else{
                            if(elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[stock="instock"]') != null){
                                elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[stock="instock"]').click()
                            }
                        }
                        if(elprodelm.querySelector('.inc_prd_desc_att_zero_bk.inc_active') != null){
                            if(elprodelm.querySelector('.inc_prd_modal_bk .inc_prd_desc_att_size_list_item_img_bk.avail') != null){
                                if(elprodelm.querySelector('.inc_prd_modal_bk .inc_prd_desc_att_zero_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                                    elprodelm.querySelector('.inc_prd_modal_bk .inc_prd_desc_att_zero_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                                }else{
                                    if(elprodelm.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail[stock="instock"]') != null){
                                        elprodelm.querySelector('.inc_prd_desc_att_size_list_item_img_bk[stock="instock"]').click()
                                    }
                                }
                            }
                        } 
                        if(elprodelm.querySelector('.inc_prd_desc_att_third_bk.inc_active') != null){
                            if(elprodelm.querySelector('.inc_prd_desc_att_third_list_item_img_bk.avail') != null){
                                if(elprodelm.querySelector('.inc_prd_desc_att_third_bk.inc_active .inc_prd_desc_att_third_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                                    elprodelm.querySelector('.inc_prd_desc_att_third_bk.inc_active .inc_prd_desc_att_third_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                                }else{
                                    if(elprodelm.querySelector('.inc_prd_desc_att_third_list_item_img_bk.avail[stock="instock"]') != null){
                                        elprodelm.querySelector('.inc_prd_desc_att_third_list_item_img_bk[stock="instock"]').click()
                                    }
                                }
                            }
                        } 
                        if(elprodelm.querySelector('.inc_prd_desc_att_size_bk.inc_active') != null){
                            if(elprodelm.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail') != null){
                                if(elprodelm.querySelector('.inc_prd_desc_att_size_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]') != null){
                                    elprodelm.querySelector('.inc_prd_desc_att_size_bk.inc_active .inc_prd_desc_att_size_list_item_img_bk.avail[data-cpid="'+main_idsd+'"][stock="instock"]').click()
                                }else{
                                    if(elprodelm.querySelector('.inc_prd_desc_att_size_list_item_img_bk.avail[stock="instock"]') != null){
                                        elprodelm.querySelector('.inc_prd_desc_att_size_list_item_img_bk[stock="instock"]').click()
                                    }
        ...
        if (product0Obj["att0Array"][0].code != "Color") {
            ...
            if (product0Obj["att0Array"].length > 0) {
                ...
                product0Obj["att0Array"].forEach(function (sizeObj) {
                    ...
                    reg.test(chckType);
                    if(sizeObj.qty_v == 99999){
                        attSizeImgBlock0.classList.add('disable_btn')
                        attSizeImgBlock0.setAttribute('stock', 'oos')
                        attSizeImgBlock0.setAttribute('style','opacity:0.3;pointer-events: none;')
                    }else{
                        attSizeImgBlock0.setAttribute('stock', 'instock');
                    }
        ...
        if (productSizesObj["sizeArray"][0].code != "Color") {
            ...
            if (productSizesObj["sizeArray"].length > 0) {
                ...
                productSizesObj["sizeArray"].forEach(function (sizeObj) {
                    ...
                    var chckType = sizeObj["text"];
                    if(sizeObj.qty_v == 99999){
                        attSizeImgBlock.classList.add('disable_btn')
                        attSizeImgBlock.setAttribute('stock', 'oos')
                        attSizeImgBlock.setAttribute('style','opacity:0.3;pointer-events: none;')
                    }else{
                        attSizeImgBlock.setAttribute('stock', 'instock');
                    }
                    reg.test(chckType);
    ...
    if (productColorsObj.colorArray.length > 0) {
        ...
        if (productColorsObj["colorArray"].length > 0) {
            productColorsObj["colorArray"].forEach(function (colorObj) {
                ...
                if(sizeObj.qty_v == 99999){
                    attColorImgBlock.classList.add('disable_btn')
                    attColorImgBlock.setAttribute('stock', 'oos')
                    attColorImgBlock.setAttribute('style','opacity:0.3;pointer-events: none;')
                }else{
                    attColorImgBlock.setAttribute('stock', 'instock');
                }
...
//     input.addEventListerner('click',(e) => console.log(e))
// }))