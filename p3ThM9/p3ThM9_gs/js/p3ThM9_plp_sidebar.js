        ...
        if (responseJSON.hasOwnProperty('CategoryRecommendations') && isrecomendation == true) {
            ...
            switch (INC.config.pageType) {
                ...
                case "productList":
                    ...
                    //             if (circle_img != null && INC.config.empty_prod_details[0] != undefined) {
...
INC.methods.createProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock) {
    ...
    elselectoptaddbtn.addEventListener('click', function () {
        ...
        if (this.querySelector('.inc_product_variant_simple_text.simple') != null) {
            ...
            var mainprodname = ""
            if (document.querySelector('.sidebar_outer.sidebar_outer_active') != null) {
                if(document.querySelector('.inc_col_desc_main_product_details_bk .inc_prd_desc_title_txt') != null){
                    var mainprodname = document.querySelector('.inc_col_desc_main_product_details_bk .inc_prd_desc_title_txt').innerText
                }
                if(document.querySelectorAll('.inc_cart_added_product_block')[0] != undefined){
                    var elprd = document.querySelectorAll('.inc_cart_added_product_block')[document.querySelectorAll('.inc_cart_added_product_block').length-1]
                    if(elprd.querySelector('.inc_cart_added_product_desc_title_text') != null){
                        mainprodname = elprd.querySelector('.inc_cart_added_product_desc_title_text').innerText.split('X')[1]
                    }
                }
...
setTimeout(function () {
    ...
    // if(document.querySelector('.inc_col_lection_checkout_btn[prd_type="simple"]') != null){
    //     var elincplpbtn=document.querySelectorAll('.inc_col_lection_checkout_btn[prd_type="simple"]')
    //     for(var b=0;b<elincplpbtn.length;b++){
    //         elincplpbtn[b].addEventListener('click',function(){
    //             var pid = this.getAttribute('prodids')
    //             var prodid=pid[0]
    //             INC.methods.irbReq(productId, 5, "catalog_product_view");
    //             INC.methods.showSidebar();
