...
setTimeout(function(){
    ...
    var jsFilePath1 = "https://www.increasingly.co/Implementation/p3ThM9/p3ThM9_gs/js/p3ThM9_plp_sidebar.js?v=" + versionUpdate1;
...
INC_COL.dataStore.methods = function () {
    ...
    function getProductopt0Obj(findObj, type_of) {
        ...
        var sizesArray = ["Small", "Medium", "Large","S", "M", "L", "XL", "XX", "XXL"];
        if (findObj.hasOwnProperty("mainId")) {
            for (mainProductId in productListObj) {
                if (mainProductId == findObj["mainId"]) {
                    for (childProductId in productListObj[mainProductId]) {
...
INC_COL.methods.irbReq_collection_bundle = function (productId) {
    ...
    if(INC_COL.config.pageType == "plpcollection"){
        if(document.querySelector('.category-intro .category-description .main-title') != null){
            ...
            }else if(document.querySelector('.breadcrumb__wrapper .breadcrumb__item') != null){
                var elbrd=document.querySelectorAll('.breadcrumb__wrapper .breadcrumb__item')
                // if(elbrd.length == 1){
                //     Pid = elbrd[elbrd.length-1].innerText
                // }else{
                //     Pid = elbrd[elbrd.length-2].innerText
                // }
                // if(Pid == 'Home' || Pid == 'HOME'){
                //     Pid = elbrd[elbrd.length-1].innerText
                // }
                Pid = elbrd[elbrd.length-1].innerText
            }else if(document.querySelector('.breadcrumb__item') != null){
                var elbrd_=document.querySelectorAll('.breadcrumb__item')
                // if(elbrd_.length == 1){
                //     Pid = elbrd_[elbrd_.length-1].innerText
                // }else{
                //     Pid = elbrd_[elbrd_.length-2].innerText
                // }
                // if(Pid == 'Home' || Pid == 'HOME'){
                //     Pid = elbrd_[elbrd_.length-1].innerText
                // }
                Pid = elbrd_[elbrd_.length-1].innerText
            }else if(document.querySelector('.department-header__header.first .department-header__header-label') != null){
                Pid = document.querySelector('.department-header__header.first .department-header__header-label').innerText.trim()
            }
            if(document.querySelector('.content-container h2') != null){
                if(document.querySelector('.content-container h2').textContent.indexOf('...') == -1 && document.querySelector('.content-container h2').textContent.indexOf('top products') == -1){
                    Pid = document.querySelector('.content-container h2').textContent.trim()
                }
            }
            if(document.querySelector('h2.expander__title') != null){
                Pid = document.querySelector('h2.expander__title').textContent.trim()
            }
            if(document.querySelector('.breadcrumb') != null){
                var elcheckcatry = document.querySelector('.breadcrumb').innerText
                if(elcheckcatry.toLocaleLowerCase().indexOf('dog') >= 0 || elcheckcatry.toLocaleLowerCase().indexOf('cat') >= 0 && Pid != undefined){
                    if(Pid.toLocaleLowerCase().indexOf('dog') == -1 && Pid.toLocaleLowerCase().indexOf('cat') == -1){
                        if(elcheckcatry.toLocaleLowerCase().indexOf('dog') >= 0 && Pid.toLocaleLowerCase().indexOf('kitten') == -1 && Pid.toLocaleLowerCase().indexOf('puppy') == -1){
                            Pid = "Dog " + Pid
                        }else if(elcheckcatry.toLocaleLowerCase().indexOf('cat') >= 0 && Pid.toLocaleLowerCase().indexOf('kitten') == -1 && Pid.toLocaleLowerCase().indexOf('puppy') == -1){
                            Pid = "Cat " + Pid
                        }
                    }
                }
            }else if(document.querySelector('.breadcrumb__wrapper .breadcrumb__item') != null){
                var elcheckcat=document.querySelectorAll('.breadcrumb__wrapper .breadcrumb__item')
                if(elcheckcat.toLocaleLowerCase().indexOf('dog') >= 0 || elcheckcat.toLocaleLowerCase().indexOf('cat') >= 0 && Pid != undefined){
                    if(Pid.toLocaleLowerCase().indexOf('dog') == -1 && Pid.toLocaleLowerCase().indexOf('cat') == -1){
                        if(elcheckcat.toLocaleLowerCase().indexOf('dog') >= 0 && Pid.toLocaleLowerCase().indexOf('kitten') == -1 && Pid.toLocaleLowerCase().indexOf('puppy') == -1){
                            Pid = "Dog " + Pid
                        }else if(elcheckcat.toLocaleLowerCase().indexOf('cat') >= 0 && Pid.toLocaleLowerCase().indexOf('kitten') == -1 && Pid.toLocaleLowerCase().indexOf('puppy') == -1){
                            Pid = "Cat " + Pid
                        }
                    }
                }
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status === 200) {
            if(xhr.response != ""){
                localStorage.setItem('irbre',JSON.stringify(xhr.response))
...
INC_COL.methods.detectPageType = function () {
    ...
    if(typeof(GTMdata) != 'undefined'){
        if(GTMdata != undefined){
            if(GTMdata.fireRemarketingEvent != undefined){
                if(GTMdata.fireRemarketingEvent.gtm_remarketingTags != undefined){
                    if(GTMdata.fireRemarketingEvent.gtm_remarketingTags.ecomm_pagetype == 'PLP' || GTMdata.fireRemarketingEvent.gtm_remarketingTags.ecomm_pagetype == 'Category'){
                        return "plpcollection";
                    } 
                } 
            } 
...
INC_COL.methods.createPLPCollectionBlock = function (response) {
    ...
    collection_plp_title_txt.innerText = "Frequently Bought Together"
    ...
    inc_col_lection_thumbnail_prev_btn.innerText = "Previous"
    ...
    inc_col_lection_thumbnail_next_btn.innerText = "Next"
    ...
    if((window.innerWidth > 420 && INC_COL.config.collection_combo_details.length > 4) || (window.innerWidth < 420 && INC_COL.config.collection_combo_details.length > 1)){
    ...
    for(k=0;k<INC_COL.config.collection_combo_details.length;k++){
        if(k < 12){
            if(INC_COL.config.collection_combo_details[k].comboId != 0){
                if(k < INC_COL.config.collection_combo_details.length){
                    ...
                    inc_col_lection_Images_bk.appendChild(collection_combo_img_wrapper)
                    ...
                    inc_col_lection_item_wrapper.appendChild(inc_col_lection_details_bk)
                    var inc_col_lection_Name_bk = generate_html_tag('div','inc_col_lection_Name_bk');
                    inc_col_lection_details_bk.appendChild(inc_col_lection_Name_bk)
                    ...
                    var inc_collection_product_wrapper_block = generate_html_tag('div','inc_collection_product_wrapper_block');
                    var inc_col_modal_title_bk = generate_html_tag('div','inc_col_modal_title_bk');
                    var inc_col_modal_title_text = generate_html_tag('div','inc_col_modal_title_text');
                    inc_col_modal_title_text.innerText="Buy This Collection"
                    inc_col_modal_title_bk.appendChild(inc_col_modal_title_text)
                    var inc_col_modal_close_icon = generate_html_tag('div','inc_col_modal_close_icon');

                    inc_col_modal_title_bk.appendChild(inc_col_modal_close_icon)
                    inc_col_modal_close_icon.addEventListener('click',function(){
                        this.parentNode.parentNode.parentNode.parentNode.querySelector('.inc_col_lection_product_list_wrapper_bk').classList.remove('inc_active')
                        document.querySelector('html').classList.remove('inc_plp_overlay')
                    })

                    inc_collection_product_wrapper_block.appendChild(inc_col_modal_title_bk)
                    var inc_col_lection_product_list_wrapper_item = generate_html_tag('div','inc_col_lection_product_list_wrapper_item');
                    inc_collection_product_wrapper_block.appendChild(inc_col_lection_product_list_wrapper_item)
                    
                    inc_col_lection_item_wrapper.appendChild(inc_col_lection_product_list_wrapper_bk)
                    inc_col_lection_product_list_wrapper_bk.appendChild(inc_collection_product_wrapper_block)
                    var inc_col_modal_checkout_bk = generate_html_tag('div','inc_col_modal_checkout_bk');
                    inc_collection_product_wrapper_block.appendChild(inc_col_modal_checkout_bk)
                    // var mhtbtn='<div class="inc_col_modal_checkout_prc_bk"><div class="inc_col_modal_checkout_prc_title">Total Price</div><div class="inc_col_modal_checkout_prc_blk"><div class="inc_col_modal_checkout_prc_active_text"></div><div class="inc_col_modal_checkout_prc_regular_text"></div></div></div><div class="inc_col_modal_basket_btn"><div class="inc_col_modal_chk_add_btn">Add to basket</div><div class="inc_col_go_to_basket_btn">View basket</div></div>'
                    // inc_col_modal_checkout_bk.innerHTML=mhtbtn
                    var inc_col_modal_checkout_prc_bk = generate_html_tag('div','inc_col_modal_checkout_prc_bk');
                    inc_col_modal_checkout_bk.appendChild(inc_col_modal_checkout_prc_bk)
                    var inc_col_modal_checkout_prc_title = generate_html_tag('div','inc_col_modal_checkout_prc_title');
                    inc_col_modal_checkout_prc_title.innerText = "Total Price"
                    inc_col_modal_checkout_prc_bk.appendChild(inc_col_modal_checkout_prc_title)
                    var inc_col_modal_checkout_prc_blk = generate_html_tag('div','inc_col_modal_checkout_prc_blk');
                    inc_col_modal_checkout_prc_bk.appendChild(inc_col_modal_checkout_prc_blk)
                    
                    var inc_col_modal_checkout_prc_active_text = generate_html_tag('div','inc_col_modal_checkout_prc_active_text');
                    inc_col_modal_checkout_prc_blk.appendChild(inc_col_modal_checkout_prc_active_text)
                    var inc_col_modal_checkout_prc_regular_text = generate_html_tag('div','inc_col_modal_checkout_prc_regular_text');
                    inc_col_modal_checkout_prc_blk.appendChild(inc_col_modal_checkout_prc_regular_text)

                    var inc_col_modal_basket_btn = generate_html_tag('div','inc_col_modal_basket_btn');
                    inc_col_modal_checkout_bk.appendChild(inc_col_modal_basket_btn)

                    var inc_col_modal_chk_add_btn = generate_html_tag('div','inc_col_modal_chk_add_btn');
                    inc_col_modal_chk_add_btn.innerText = "Add to basket"
                    inc_col_modal_chk_add_btn.setAttribute('multipack',INC_COL.config.collection_combo_details[k].ComboProductURL)
                    inc_col_modal_basket_btn.appendChild(inc_col_modal_chk_add_btn)

                    inc_col_modal_chk_add_btn.addEventListener('click',function(){
                        this.innerText = "Adding..."
                        INC_COL.dataStore.bundleCartProducts = {}
                        INC_COL.config.bundle_tracking=[]
                        var elprdb = this.parentNode.parentNode.parentNode.querySelectorAll('.inc_prd_module_bk .inc_prd_showcase_bk .inc_prd_bk')
                        var eladdedp=this.parentNode.parentNode.parentNode.querySelectorAll('.inc_prd_module_bk .inc_prd_showcase_bk .inc_prd_bk .inc_prd_desc_add_bk.Inc_checked')
                        var qtymultipack=0
                        var checkcombo = false
                        var checkcomboProd = []
                        var combocount = 0
                        for(var tc=0;tc<elprdb.length;tc++){
                            if(elprdb[tc].querySelector('.inc_prd_desc_add_bk.Inc_checked') != null){
                                combocount++
                                var id_c = elprdb[tc].getAttribute('data-id');
                                if(checkcomboProd.indexOf(id_c) == -1){
                                    checkcomboProd.push(id_c)
                                }
                            }
                            if(elprdb.length == tc+1){
                                if(combocount == 2 && checkcomboProd.length == 1 && this.getAttribute('multipack').indexOf('multipack') >= 0){
                                    checkcombo = true
                                }
                            }
                        }
                        console.log("checkcombo - " + checkcombo)
                        for(var t=0;t<elprdb.length;t++){
                            if(elprdb[t].querySelector('.inc_prd_desc_add_bk.Inc_checked') != null){
                                ...
                                var bid = productBlockNode.getAttribute('data-bundle_id');
                                var comboid = productBlockNode.getAttribute('data-comboid');
                                var qty = productBlockNode.querySelector('.inc_prd_desc_qty_input_text input').value;
                                var multiqty=0
                                if(elprdb[1].querySelector('.inc_prd_desc_add_bk.Inc_checked') != null){
                                    multiqty = elprdb[1].querySelector('.inc_prd_desc_qty_input_text input').value;
                                }   
                                qtymultipack = parseInt(multiqty) + parseInt(qty)
                                if(checkcombo == true  && t == 0){
                                    INC_COL.dataStore.bundleCartProducts[sku] = qtymultipack;
                                ...
                                }else if(checkcombo == false){
                                    INC_COL.dataStore.bundleCartProducts[sku] = qty;
                                    INC_COL.config.bundle_tracking.push({
                                        id: id,
                                        bid: bid,
                                        combo_id:comboid,
                            ...
                            if(elprdb.length == t+1){
                                ...
                                INC_COL.methods.addBundleToCartcol(this,'plp_modal_add');
                            }
                        }
                    })

                    var inc_col_go_to_basket_btn = generate_html_tag('div','inc_col_go_to_basket_btn');
                    inc_col_go_to_basket_btn.innerText = "View Basket"
                    inc_col_modal_basket_btn.appendChild(inc_col_go_to_basket_btn)
                    inc_col_go_to_basket_btn.addEventListener('click',function(){
                    ...
                    for(p=0;p<INC_COL.config.collection_combo_details[k].collection_bundles.length;p++){
                        for(r=0;r<INC_COL.config.collection_combo_details[k].collection_bundles[p].products.length;r++){
                            if(r<4){ 
                                ...
                                collection_combo_img.src=INC_COL.config.collection_combo_details[k].ComboImageURL
                                if(productObj.ProductType == "configurable"){
                                    inc_col_lection_item_bk.classList.add('configurable')
                                    prdtype = "configurable"
                                    
                                    var obj1 = INC_COL.dataStore.dataStoreObj[product_id];
                                    ...
                                    inc_col_lection_item_bk.classList.add('simple')
                                    price_array.push(productObj.activePrice)
                                }
                                if(title_fbt == ""){
                                    title_fbt = productObj.name
                                }else{
                                    title_fbt = title_fbt + " + " + productObj.name
                                }
                                price_range = price_array.filter(Number);
                                prod_col_ids.push(productObj.id)
                                ...
                                //inc_col_lection_product_list_wrapper_bk
                                var prd_id=INC_COL.config.collection_combo_details[k].collection_bundles[p].products[r]
                                var firstProductObjByMainId = INC_COL.dataStore.methods().getFirstProductObjByMainId({ mainId: prd_id });
                                var colproductBlock = this.createcolProductModuleBlock(firstProductObjByMainId.id, "plpcollection", true,'plpBlockcol');
                                colproductBlock.classList.add('inc_go_well')
                                inc_col_lection_product_list_wrapper_item.appendChild(colproductBlock);
                                var field1 = productObj.ratingsCount;
                                
                                if(bestrating.split("|")[0] < productObj.ratingsCount.split("|")[0]){
                                    bestrating = productObj.ratingsCount
                                    bestrating1  = productObj.reviewsCount
                                }
                            }    
                        }
                    }
                    console.log(JSON.stringify(price_range))
                    var min = Math.min.apply(Math, price_range);
                    var max = Math.max.apply(Math, price_range);
                    if(bestrating != "0"){
                        INC_COL.methods.get_product_ratingscol(bestrating, bestrating1, inc_col_lection_Rating_bk);
                    }

                    inc_col_lection_regular_price.innerText = "";
                    if(prdtype != "simple"){
                        inc_col_lection_regular_price.innerHTML = ""
                        var actprc = formatter.format(min).replace(',','.').replace(/\s/g, '') 
                        var maxactprc = formatter.format(max).replace(',','.').replace(/\s/g, '') 
                        inc_col_lection_active_price.setAttribute('prdtype',prdtype)
                        inc_col_lection_active_price.innerHTML = "<span>From </span>" + actprc + " - " + maxactprc
                        if (pr != sp && sp != 0) {
                            inc_col_lection_item_bk.classList.add('inc_special_prc')
                        }
                    }else{
                        if (pr != sp && sp != 0) {
                            var actprc = formatter.format(sp).replace('£','').replace(',','.').replace(/\s/g, '');
                            var regpr =  formatter.format(pr).replace('£','').replace(',','.').replace(/\s/g, '');
                            inc_col_lection_active_price.parentNode.classList.add('is_special_price')
                            inc_col_lection_active_price.innerText =  formatter.format(actprc)//  + ",00 £"
                            inc_col_lection_regular_price.innerHTML =  "was " + formatter.format(regpr)//  + ",00 £"
                    ...
                    inc_col_lection_item_bk.setAttribute('comboid',INC_COL.config.collection_combo_details[k].comboId)
                    ...
                    inc_col_lection_Name_text.innerText  = title_fbt //ComboTitle
                    inc_col_lection_Name_text.setAttribute('title',title_fbt)
                    ...
                    // inc_col_lection_Name_text.setAttribute('href','#')
                    ...
                    var inc_col_lection_checkout_btn = generate_html_tag('div','inc_col_lection_checkout_btn');
                    var inc_col_lection_checkout_btn_text = generate_html_tag('div','inc_col_lection_checkout_btn_text');
                    inc_col_lection_checkout_btn.setAttribute('prd_type',prdtype)
                    if(prdtype == "simple"){
                        inc_col_lection_checkout_btn_text.innerText = "Add to basket"
                    }else{
                        inc_col_lection_checkout_btn_text.innerText = "More details"
                    }
                    ...
                    inc_col_lection_checkout_btn.setAttribute('prodids',prod_col_ids)
                    
                    inc_col_lection_checkout_btn.setAttribute('comboid',INC_COL.config.collection_combo_details[k].comboId)
                    inc_col_lection_details_bk.appendChild(inc_col_lection_checkout_btn);
                    inc_col_lection_checkout_btn.addEventListener('click',function(){
                        if(this.getAttribute('prd_type') == "simple"){
                            var addprodids=this.getAttribute('prodids').split(',')
                            INC_COL.dataStore.bundleCartProducts = {}
                            var elmbtn=this
                            elmbtn.innerText = "Adding..."
                            INC_COL.config.bundle_tracking=[]
                            ...
                            // INC.methods.irbReq(addprodids[0], 10, "catalog_product_view");
                            
                            for(var t=0;t<addprodids.length;t++){
                                if(this.getAttribute('producturl').indexOf('multipack') >= 0){
                                    INC_COL.dataStore.bundleCartProducts[addprodids[t]] = 2;
                                    var qty = 2;
                                }else{
                                    INC_COL.dataStore.bundleCartProducts[addprodids[t]] = 1;
                                    var qty = 1;
                                }
                               
                                var sku = addprodids[t];
                                var id = addprodids[t];
                                var bid = this.getAttribute('comboid');
                                var comboid = this.getAttribute('comboid');
                               
                                INC_COL.dataStore.bundleCartProducts[sku] = qty;
                                if(this.getAttribute('producturl').indexOf('multipack') >= 0 && t == 0){
                                    INC_COL.config.bundle_tracking.push({
                                        id: id,
                                        bid: bid,
                                        combo_id:comboid,
                                ...
                                }else if(this.getAttribute('producturl').indexOf('multipack') == -1){
                                    INC_COL.config.bundle_tracking.push({
                                        id: id,
                                        bid: bid,
                                        combo_id:comboid,
                                ...
                                if(addprodids.length == t+1){
                                    // checkAddedProductInJustAddedcol()
                                    INC_COL.methods.addBundleToCartcol(elmbtn,'plp_modal_add');
                                }
                            }
                        }else{
                            var elplprp=this.parentNode.parentNode.parentNode.querySelector('.inc_col_lection_product_list_wrapper_bk')
                            document.querySelector('html').classList.add('inc_plp_overlay')
                           
                            var elProductAddBlock = elplprp.querySelectorAll('.inc_prd_desc_add_bk')
                            for (var i = 0; i < elProductAddBlock.length; i++) {
                                if(i == 0 || i == 2 || i == 4 || i == 6){
                                    if(elProductAddBlock[i] != undefined){
                                        if(elProductAddBlock[i].classList.contains('Inc_checked') == false){
                                            var elprodelm=elProductAddBlock[i].parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                                            var main_idsd = elprodelm.getAttribute('data-main_id')
                                            if(elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"]') != null){
                                                if(elprodelm.querySelector('.inc_prd_desc_att_color_list_item_img_bk[data-cpid="'+main_idsd+'"] .inc_prd_desc_att_color_list_item_img') != null){
                            ...
                            var elprd=this.getAttribute('prodids').split(',')
                            if (document.querySelector('.sidebar_outer') != null) {
                                Array.prototype.forEach.call(document.querySelectorAll('.sidebar_outer'), function (el) {
                                    el.parentNode.removeChild(el);
                                });
                            ...
                            // INC.methods.irbReq(elprd[0], 10, "catalog_product_view");
                           
                            elplprp.addEventListener('click',function(e){
                                if(e.target.className == 'inc_col_lection_product_list_wrapper_bk inc_active'){
                                    this.classList.remove('inc_active')
                                    document.querySelector('html').classList.remove('inc_plp_overlay')
                                }
                                if (e.target.classList.contains('inc_prd_variant_simple_text') == false && e.target.classList.contains('inc_prd_desc_att_bk') == false && e.target.classList.contains('inc_prd_desc_att_bk') == false && e.target.classList.contains('inc_prd_desc_att_size_bk') == false && e.target.classList.contains('inc_prd_desc_att_size_list_bk') == false && e.target.classList.contains('inc_prd_desc_att_size_list_item_img_bk') == false && e.target.classList.contains('inc_prd_desc_att_size_list_item_img') == false && e.target.classList.contains('inc_prd_desc_att_bk') == false) {
                                    if(this.querySelector('.inc_prd_desc_att_bk.inc_active') != null){
                                        this.querySelector('.inc_prd_desc_att_bk.inc_active').classList.remove('inc_active')
                                    }
                                }
                            })
                            setTimeout(function(){
                                elplprp.classList.add('inc_active')
                                INC_COL.methods.updateplpactivemodalprc(elplprp)
                            },300)
                        }
                    })
                }
    ...
    var plpeldessib = document.querySelector('.wrapper[data-module="wrapper"] section')
    //wrapper layout3 wrapper--light-green rich-relevance
    if(document.querySelector('#searchBasedNavigation_widget') != null){
        var elplpbest1=document.querySelector('#searchBasedNavigation_widget')
        elplpbest1.parentNode.insertBefore(inc_col_lection_bk, elplpbest1);
    }else if(plpeldessib != null){
        plpeldessib.parentNode.insertBefore(inc_col_lection_bk, plpeldessib);
    }else if(plp_spl_elm != null){
    ...
    }else if(document.querySelector('.best-sellers') != null){
        var elplpbest=document.querySelector('.best-sellers')
        elplpbest.parentNode.insertBefore(inc_col_lection_bk, elplpbest);
    }else if(document.querySelector('.our-services.container-full-vw') != null){
        var el_plpad=document.querySelector('.our-services.container-full-vw')
        el_plpad.parentNode.insertBefore(inc_col_lection_bk, el_plpad);
    }
    
    irbobservload=true
    
}
INC_COL.methods.updateplpactivemodalprc = function (prdel) {
    var elprice = prdel.querySelectorAll('.inc_prd_module_bk') 
    var activepriceary = 0
    var regularpriceary = 0
    for(var p=0;p<elprice.length;p++){
        if(elprice[p].querySelector('.inc_prd_desc_add_bk.Inc_checked') != null){
            var prcact = elprice[p].querySelector('.inc_prd_showcase_bk .inc_prd_desc_ecirp_active_text').innerText.replace('£','').replace(',','').trim()
            var prcreg = elprice[p].querySelector('.inc_prd_showcase_bk .inc_prd_desc_ecirp_regular_text').innerText.replace('£','').replace(',','').replace('Was','').trim()
            if(prcreg == "" || prcreg == 0){
                prcreg = prcact
            }
            var qtye = elprice[p].querySelector('.inc_prd_desc_qty_input_text input').value
            activepriceary = +activepriceary +  +(prcact * qtye)
            regularpriceary =  +regularpriceary +  +(prcreg * qtye)
        }
    }
    if(prdel.querySelector('.inc_col_modal_checkout_prc_active_text') != null){
        prdel.querySelector('.inc_col_modal_checkout_prc_active_text').innerHTML = formatter.format(activepriceary)
    }
    if(parseFloat(activepriceary) != 0 && parseFloat(activepriceary) < parseFloat(regularpriceary) && parseFloat(regularpriceary) != parseFloat(activepriceary)){
        ...
        prdel.querySelector('.inc_col_modal_checkout_prc_regular_text').innerHTML = "<span>Save</span> " + formatter.format(totalsave);
        var cid_=elprice[0].getAttribute('data-comboId')
        if(document.querySelector('.inc_col_lection_item_bk[comboid="'+cid_+'"]') != null){
            document.querySelector('.inc_col_lection_item_bk[comboid="'+cid_+'"]').classList.add('inc_special_prc')
        }
    }else{
        prdel.querySelector('.inc_col_modal_checkout_prc_regular_text').innerHTML = "";
    }
    if(activepriceary == 0){
        prdel.querySelector('.inc_col_modal_checkout_bk').classList.add('disable_btn')
        prdel.querySelector('.inc_col_modal_chk_add_btn').setAttribute('style','pointer-events: none;opacity: 0.5;')
        prdel.querySelector('.inc_col_go_to_basket_btn').setAttribute('style','pointer-events: none;opacity: 0.5;')
        prdel.querySelector('.inc_col_modal_checkout_prc_bk').setAttribute('style','visibility: hidden;')
    }else{
        prdel.querySelector('.inc_col_modal_checkout_bk').classList.remove('disable_btn')
        prdel.querySelector('.inc_col_modal_chk_add_btn').setAttribute('style','pointer-events: auto;opacity: 1')
        prdel.querySelector('.inc_col_go_to_basket_btn').setAttribute('style','pointer-events: auto;opacity: 1;')
        prdel.querySelector('.inc_col_modal_checkout_prc_bk').setAttribute('style','visibility: visible;')
    }
    // if(prdel.parentNode.querySelector('.inc_col_lection_active_price') != null){
    //     prdel.parentNode.querySelector('.inc_col_lection_active_price').innerHTML = formatter.format(activepriceary)
    // }
    setTimeout(function(){
        onloadpdp = true
        onloadpdp_delete = true
...
INC_COL.methods.createcolProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock,elProductShowcaseBlock,mainprod) {
    ...
    // if (productBlock.parentNode.parentNode.parentNode.classList.contains('inc_pdp_product-main_bk') != true){
        ...
        if(INC_COL.config.pageType == "plpcollection"){
            ...
            elImgMainImg.addEventListener("click", function (ee) {
                if(window.innerWidth < 820){
                    ee.preventDefault();
                }
                INC_COL.methods.sendBundleClickTracking(productObj.mainId);
                var href = productBlock.querySelector('.inc_prd_desc_title_txt a').href
                getTrackingPixel();
                if(window.innerWidth < 820){
                    setTimeout(function(){
                        window.location.href = href
    ...
    elQtyInput.addEventListener("keydown", function (event) {
        ...
        // } else {
            setTimeout(function () {
                ...
                if(INC_COL.config.pageType == "plpcollection"){
                    var elmact = document.querySelector('.inc_col_lection_product_list_wrapper_bk.inc_active')
                    if(elmact != null){
                        INC_COL.methods.updateplpactivemodalprc(elmact)
                    }
                }
            }, 50);
        // }
    ...
    if (productColorsObj["colorArray"].length == 0 && sizezero["att0Array"].length == 0 && product3Obj["att3Array"].length == 0 && productSizesObj["sizeArray"].length == 0) {
        ...
        if(INC_COL.config.pageType == "plpcollection"){
            elconfigtitle.textContent = "Please select the Size";
        }
        switch (blockType) {
            case "pdpcollection": eladdvarianttext.textContent = "Add"; break;
        }
        ...
        if(INC_COL.config.pageType == "plpcollection"){
            elconfigtitle.textContent = "Please select the Volume";
        }
        switch (blockType) {
            case "pdpcollection": eladdvarianttext.textContent = "Add"; break;
        }
        ...
        if (productSizesObj["sizeArray"].length > 0) {
            ...
            if(INC_COL.config.pageType == "plpcollection"){
                elconfigtitle.textContent = "Please select the Weight";
            }
            switch (blockType) {
                case "pdpcollection": eladdvarianttext.textContent = "Add"; break;
            }
...
INC_COL.methods.mappvariants = function (obj, blocktype, type_of_variant) {
    ...
    if (obj.parentNode != undefined) {
        ...
        }else if(document.querySelector('.inc_col_desc_main_product_details_bk .inc_prd_desc_att_color_bk') != null){
            if(document.querySelector('.inc_col_desc_main_product_details_bk .inc_prd_desc_att_color_bk').classList.contains('inc_active') == true){
    ...
    if(INC_COL.config.pageType == 'plplpcollectionp'){
        if(document.querySelector('.inc_prd_desc_att_bk.attributes_avail.inc_active') != null){
            document.querySelector('.inc_prd_desc_att_bk.attributes_avail.inc_active').classList.remove('inc_active')
        }
    }
}
...
INC_COL.methods.updatecolProductBlock = function (productBlock, findObj, blockType, bundleProductListCheck) {
    ...
    if (productBlock.querySelector('.inc_prd_variant_simple_text') != null) {
        if(blockType == "sidebar" || blockType == "am"){
            ...
            if(productModuleBlock.querySelector('.inc_prd_bk .inc_prd_add_bk.added_inc') != null || blockType == "plpcollection"){
    ...
    if(blockType == "plpcollection"){
        ...
        if(document.querySelector('.inc_col_lection_product_list_wrapper_bk.inc_active .inc_prd_desc_att_bk.inc_active') != null){
            document.querySelector('.inc_col_lection_product_list_wrapper_bk.inc_active .inc_prd_desc_att_bk.inc_active').classList.remove('inc_active')
        }
    }
}
...
INC_COL.methods.addBundleToCartcol = function (btn_cart,plp_modal_add) {
    ...
    Object.keys(dataStore.bundleCartProducts).forEach(function (bundleCartProduct) {
        ...
        if (total_length.length == count_pr_to_add) {
            ajax_add_to_cart_col(formData, btn_cart, mainProductId, url0, url1, url2, url3, url4, url5,pid0,pid1,pid2,pid3,pid4,pid5,plp_modal_add)
...
function ajax_add_to_cart_col(formData, btn_cart, mainProductId, url0, url1, url2, url3, url4, url5,p0,p1,p2,p3,p4,p5,plp_modal_add) {
    INC_COL.clientConfig.OOS = []
    ...
    function callprodA() {
        ...
        dojo.xhrPost({
            ...
            load: function(_255, _256) {
                ...
                if (url1 == undefined) {
                    if(plp_modal_add == 'plp_modal_add'){
                        btn_cart.innerText = "Added"
                        setTimeout(function(){
                            if(document.querySelector('.inc_col_lection_product_list_wrapper_bk.inc_active') != null){
                                document.querySelector('.inc_col_lection_product_list_wrapper_bk.inc_active').classList.remove('inc_active')
                                document.querySelector('html').classList.remove('inc_plp_overlay')
                            }
                        },500)
                        setTimeout(function(){
                            btn_cart.innerText = "Add to basket"
                        },1000)
                    }
                ...
                callbacksuccessincol(_255, _256)
...
function callbacksuccessincol(_255, _256){
    var _257 = _256.args.service;
    if( _256.args.service == undefined){
        if(document.querySelector('.device') != null || window.innerWidth < 600){
            _256.args.service = {"id":"AddOrderItemDesktop","actionId":"AddOrderItem","url":"https://www.petsathome.com/webapp/wcs/stores/servlet/AjaxOrderChangeServiceItemAdd","formId":"","successCallback":null}
            _255.serviceId ="AddOrderItemDesktop";
            _255.actionId ="AddOrderItem";
        }else{
            _256.args.service = {"id":"AddOrderItem","actionId":"AddOrderItem","url":"https://www.petsathome.com/webapp/wcs/stores/servlet/AjaxOrderChangeServiceItemAdd","formId":"","successCallback":null}
            _255.serviceId ="AddOrderItem";
            _255.actionId ="AddOrderItem";
        }
    ...
    dojo.publish("ajaxRequestCompleted");
    var checknoimg = setInterval(function(){
        if(document.querySelector('.dialog__img') != null){
            clearInterval(checknoimg)
            if(document.querySelector('.dialog__img').getAttribute('alt') == "image not found"){
                document.querySelector('.dialog__img').setAttribute('alt',"")
            }
            if(document.querySelector('.dialog__img').getAttribute('alt') == "image not found"){
                document.querySelector('.dialog__img').setAttribute('alt',"")
            }
            ...
            if(clickedElement != null){
                ...
                if (clickedElement.parentNode != null) {
                    if (clickedElement.className != "inc_prd_desc_att_color_title_txt_bk" && clickedElement.className != "inc_prd_desc_att_color_title_txt_selected" && clickedElement.parentNode.className != "inc_prd_desc_att_color_title_txt_bk" && clickedElement.className != "inc_prd_desc_att_zero_title_txt" && clickedElement.className != "inc_prd_desc_att_zero_title_txt_bk" && clickedElement.className != "inc_prd_desc_add_bk" && clickedElement.className != "inc_prd_desc_add_text" && clickedElement.className != "img_color_swatch" && clickedElement.className != "inc_prd_desc_att_zero_title_txt_selected" && clickedElement.classList.contains('inc_prd_desc_att_color_list_item_img') != true && clickedElement.classList.contains('inc_prd_desc_att_zero_title_txt_selected') != true) {
                        ...
                        if (document.querySelector('.inc_prd_desc_att_bk.inc_active') != null && INC_COL.config.pageType == "plpcollection") {
                            document.querySelector('.inc_prd_desc_att_bk.inc_active').classList.remove('inc_active')
                        }
                    }
    ...
    recModuleArray.forEach(function (mainProductId) {
        if(INC_COL.config.duplamid.indexOf(mainProductId) == -1){
            ...
            if (Object.keys(productObj).length != 0) {
              ...
              inc_collection_checkout_btn_text.innerText = "Add to basket"
  ...
  jQuery.ajax({
      ...
      success: function(res) {
          ...
          function addCSSFile1() {
              var cssFilePath1 = "https://ui.powerreviews.com/tag-builds/10385/4.0/styles.css";
          ...
          if(res.results[0] != undefined){
            ...
            total_rating = res.results[0].rollup.average_rating
            ...
            if(window.innerWidth > 767){
              ...
              for(var k = 0;k<rating_insta.length;k++){
                ...
                pr_ratings_item.addEventListener('click',function(){
                    ...
                    if(rat_filter != 0 && rat_filter != "0"){
                        var param = 'https://display.powerreviews.com/m/8192/l/en_US/product/'+INC_COL.config.pdpPID+'/reviews?filters=rating:'+rat_filter+'&_noconfig=true&apikey=4f609daa-0f5e-4005-8225-44c637d5e424'
              ...
              for(var r = 0;r<res.results[0].reviews.length;r++){
                ...
                if(res.results[0].reviews[r].details.bottom_line == "Yes"){
                  ...
                  bottom_ln = "I would not recommend to a friend"
                }
                ...
                for(var pt=0;pt<pro_val.length;pt++){
                    ...
                    }else if(pro_val[pt].label == "Best Uses"){
                        var dl_el = generate_html_tag('dl','pr-rd-review-tag')
                        pr_review_condensed.querySelector('.pr-rd-tags.pr-rd-content-block').appendChild(dl_el)
                        var dt_el = generate_html_tag('dt')
                    ...
                    }else if(pro_val[pt].label == "Describe Yourself"){
                ...
                if(res.paging.pages_total > 1 && res.results[0].reviews.length == r+1){
                  ...
                  pagincblock.innerHTML = '<footer class="pr-rd-main-footer"><div class="pr-rd-content-block"><p class="pr-rd-review-position"><span>Displaying Reviews </span><span class="pr-rd-bold"> 1-5</span></p><a href="#" class="pr-rd-to-top pr-underline" aria-label="Back to Top">Back to Top</a><div class="pr-rd-pagination"><a href="#" class="pr-rd-pagination-btn pr-rd-pagination-btn--next" nextpage="'+nextpageurl+'" currentpage='+res.paging.current_page_number+'>Next<span aria-hidden="true"> »</span></a></div></div></footer>'
