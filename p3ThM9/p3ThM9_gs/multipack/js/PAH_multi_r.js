...
setTimeout(function(){
    ...
    var jsFilePath1 = "https://www.increasingly.co/Implementation/p3ThM9/p3ThM9_gs/multipack/js/p3ThM9_org.js?v=" + versionUpdate1;
...
INC_COL.methods.createPDPCollectionBlock = function (sidebar) {
    ...
    if(INC_COL.config.maincolText != null){
       ...
       if(inc_click_collect_pop.querySelector('.inc_click_collect_std .click-collect__text') != null){
          if(inc_click_collect_pop.querySelector('.inc_click_collect_std .click-collect__text').innerText.indexOf('Click & Collect is a FREE and convenient') >= 0){
    ...
    function inputqtyfn(ev){
        ...
        // if (mainelQtyInput.value.length == 0){
            setTimeout(function () {
                ...
                if (mainelQtyInput.value > 99) mainelQtyInput.value = 99;
...
INC_COL.methods.createcolProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock,elProductShowcaseBlock,mainprod) {
    ...
    if(productObj.PromotionalMessage != 'null' && productObj.PromotionalMessage != "" && productObj.PromotionalMessage != undefined){
        ...
        if(productObj.PromotionalMessage.split('|')[1] != null){
            ...
            productBlock.querySelector('.pc_promo_div').innerHTML = productObj.PromotionalMessage;
...
INC_COL.methods.createcolProductModalBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock,elmodalblock,mainprod) {
    ...
    //var promo_div = "<div class='pc_promo_div inc_active'><span class='ec_avail_offer'></span><span class='pc_promo_span red_promo'>"+productObj.PromotionalMessage+"</span></div>";
