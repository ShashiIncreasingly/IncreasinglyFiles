...
function addCSSFile() {
    var versionUpdate = (new Date()).getTime();
    var cssFilePath = "https://www.increasingly.co/Implementation/fbt/css/p3ThM9.css?v=" + versionUpdate;
    var linkTag = document.createElement('link');
    linkTag.rel = "stylesheet";
    linkTag.href = cssFilePath;
    document.querySelector('head').appendChild(linkTag);
...
setTimeout(function(){
    ...
    var jsFilePath1 = "https://www.increasingly.co/Clients/optimised/js/p3ThM9_org.js?v=" + versionUpdate1;
...
INC_COL.dataStore.methods = function () {
    ...
    function buildDataStoreObj(bundleResponse,collection) {
        ...
        if(collection_count == 0){
            irbobservload=true
            var remlo = document.querySelector('#loader_block_inc')
            if(remlo != null){
...
INC_COL.classes.ProductAttObj = function (product) {
    ...
    if(product["childProductSpecialPrice"] == 0 || product["childProductSpecialPrice"] == 0.00){
    ...
    if(product["childProductSpecialPriceMain"] == 0 || product["childProductSpecialPriceMain"] == 0.00){
...
INC_COL.methods.get_product_ratingscol = function(filed3, field2,rating_containers) {
    ...
    if (filed3 != null){
        var reviewc = filed3.split('|')[1].trim();
    }
...
INC_COL.methods.createPDPCollectionBlock = function (sidebar) {
    ...
    if (INC_COL.dataStore.dataStoreObj.undefined != undefined || empty_sidebarflag == false) {
        ...
        //     pdp_placementempty.parentNode.insertBefore(pdpBlockcol,pdp_placementempty);
        // }else if(pdp_placement != null){
        //     var nepl = pdp_placement.nextElementSibling
        //     nepl.parentNode.insertBefore(pdpBlockcol,nepl);
        // }else if(pdp_placement1 != null){
        //     pdp_placement1.parentNode.insertBefore(pdpBlockcol,pdp_placement1);
        // }else if(pdp_new_placement != null){
        //     pdp_new_placement.parentNode.insertBefore(pdpBlockcol,pdp_new_placement);
        // }
        ...
        var main_idsd = mainproductb.getAttribute('data-sku')
...
INC_COL.methods.createcolProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock,elProductShowcaseBlock,mainprod) {
    ...
    if ((INC_COL.config.pageType == "pdpcollection" && window.innerWidth < 821 || blockType == "sidebar" || blockType == "am") && mainprod != "mainprod") {
    ...
    } else if(mainprod == "mainprod" && INC_COL.config.pageType == "pdpcollection"){
        ...
        elImgMainImg.addEventListener("click", function () {
            ...
            //     inc_col_scroll_height = (window.pageYOffset || doc.scrollTop)  - (doc.clientTop || 0);
            // }
            // if (productBlock.parentNode.parentNode.querySelector('.inc_prd_modal_bk .inc_col_hdr_bk') != null) {
            //     productBlock.parentNode.parentNode.querySelector('.inc_prd_modal_bk .inc_col_hdr_bk').click()
            // }
            ...
            // productBlock.parentNode.parentNode.querySelector('.inc_prd_modal_bk .inc_prd_hdr_title_txt_bk').click()
            // document.querySelector('html').classList.add('inc_overlay');
    ...
    if (blockType == "pdpcollection" && INC_COL.config.Product_id == productObj.mainId) {
    ...
    if (INC_COL.config.pageType == "pdpcollection" && INC_COL.config.recommendation) {
    ...
    if (activePrice != regularPrice && regularPrice != "" && regularPrice != null && regularPrice != 0) {
        ...
        if(totalsaveper>0){
            elworthPrice.innerHTML = totalsaveper +"% Off";
        }
    } else {
        elPriceActiveText.innerHTML = formatter.format(activePrice)
        elPriceHrdActiveText.innerHTML = formatter.format(activePrice)
...
INC_COL.methods.createcolProductModalBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock,elmodalblock) {
    ...
    elHeader.querySelector('.inc_prd_hdr_img_bk').addEventListener("click", function () {
        ...
        if (document.querySelector('.inc_prd_modal_bk.inc_active') == null && document.querySelector('body.active-gnav, body.product-shades-sidebar-active') == null) {
    ...
    elGalleryRightArrow.addEventListener("click", function (e) {
        ...
        slideToCollection(pr_id,0,prod_card,"right","arrow")
    });
    elGallerylefttArrow.addEventListener("click", function (e) {
        var prod_card=this.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode;
        var pr_id=prod_card.getAttribute('data-main_id')
        slideToCollection(pr_id,0,prod_card,"left","arrow")
    });
    if ((productObj.otherImageList == null) || productObj.otherImageList.length < 2) {
        elGalleryRightArrow.style.display = "none"
        elGallerylefttArrow.style.display = "none"
    ...
    elAddBlock.addEventListener("click", function () {
        ...
        if (INC_COL.config.pageType != "cartPage" && !INC_COL.config.recommendation && INC_COL.config.pageType != "ticket" && productModuleBlock.parentNode.className.indexOf('inc_af_product-list_bk') == -1) {
...
INC_COL.methods.updatecolProductBlock = function (productBlock, findObj, blockType, bundleProductListCheck) {
    ...
    if (Object.keys(productObj).length != 0) {
        ...
        if (elTitleText.querySelector('strong') != null && window.innerWidth < 821 && INC_COL.config.pageType == "pdpcollection") {
...
function checkAddedProductInJustAddedcol(){
    ...
    for (ct = 0; ct < categoryList.length; ct++) {
        ...
        for (var ij = 0; ij < productListArrayprod.length; ij++) {
            var firstProductObjByMainId = INC_COL.dataStore.methods().getFirstProductObjByMainId({ mainId: productListArrayprod[ij] });
    ...
    if (document.querySelector('.inc_recommended_tabs_list_item_block') != null) {
        ...
        if (document.querySelector('.inc_recommended_tabs_list_item_block .inc_product_module_block') == null) {
...
function cb_tc_col(bundle_response,recommendation){
    ...
    setTimeout(function() {
        ...
        if(recModuleArray.length>3){
            ...
            INC_COL.config.rectop = recModuleArray.splice(0, middleIndex);   
            INC_COL.config.recbottom = recModuleArray.splice(-middleIndex);
            setTimeout(function(){
...
INC_COL.methods.createRECBlock = function () {
    ...
    var cart_html = '<div class="inc_af_title_block" style="clear: both;"><div class="inc_af_title_text_block"><div class="inc_af_title_text">Best Selling Similar Products</div><div class="inc_af_modal_close"></div></div></div><div class="inc_af_bundles_block"><div class="inc_af_left_block"><div class="inc_af_left_btn_block"><div class="inc_af_left_btn_img_block"><div class="inc_af_left_btn_img"></div></div></div></div><div class="inc_af_product-list-main_block"><div class="inc_af_product-list_block"></div></div><div class="inc_af_right_block"><div class="inc_af_right_btn_block"><div class="inc_af_right_btn_img_block"><div class="inc_af_right_btn_img"></div></div></div></div></div>'
    ...
    if(window.innerWidth>820){
        var tplayoutsibling=document.querySelector('.inc_bk .inc_main_product_description_bk')
        ...
        if(INC_COL.config.duplamid.indexOf(mainProductId) == -1){
            ...
            if (activePrice != regularPrice && regularPrice != "" && regularPrice != null && regularPrice != 0) {
                ...
                if (productObj.pricingCount != "") {
                    elPriceActiveText.innerHTML = "<span>" + formatter.format(activePrice) + "</span>"
    ...
    amBlock.querySelector('.inc_af_right_btn_block').addEventListener("click", function () {
        ...
        if (+INC_COL.clientConfig.slidevalue + +cc_ount < all_p_length) {
            ...
            if (document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalue] != null) document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalue].classList.add('inc_active')
        }
...
INC_COL.methods.createRECBlockTop = function () {
    ...
    var amMainBlock = generate_html_tag('div', 'inc_af_main_block_top');
    // amMainBlock.style.display="none"
    amMainBlock.appendChild(amBlock);
    ...
    amBlock.querySelector('.inc_af_right_btn_block').addEventListener("click", function () {
        ...
        var all_p_length = document.querySelectorAll('.inc_af_main_block_top .inc_af_product-list_block .inc_product_module_block').length
        var cc_ount = 1;
        if (window.innerWidth > 768) {
            cc_ount = 4
        }
        ...
        if (+INC_COL.clientConfig.slidevalueTop + +cc_ount < all_p_length) {
            amBlock.parentNode.parentNode.querySelector('.inc_af_left_btn_block').setAttribute("style", "pointer-events: auto;opacity:1");
            amBlock.parentNode.parentNode.querySelector('.inc_af_left_btn_img').setAttribute("style", "pointer-events: auto;opacity:1");
            INC_COL.clientConfig.slidevalueTop++
            INC_COL.clientConfig.offset = (parseInt(INC_COL.clientConfig.offset) - width_slide) + 'px';
            var menu = amBlock.parentNode.parentNode.querySelector('.inc_af_product-list_block');
            menu.setAttribute('style', 'margin-left:' + INC_COL.clientConfig.offset + ';transition-duration:0.5s;-webkit-transition-duration:0.5s;-moz-transition-duration:0.5s;-ms-transition-duration:0.5s;-o-transition-duration:0.5s;')
            if (document.querySelector('.inc_af_product-list-dots-main_block .inc_dots.inc_active') != null) {
            ...
            if (document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalueTop] != null) document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalueTop].classList.add('inc_active')
        }
    ...
    amBlock.querySelector('.inc_af_left_btn_block').addEventListener("click", function () {
        ...
        if (sliderBtnCounter == -1) sliderBtnCounter = 0;
        var all_p_length = document.querySelectorAll('.inc_af_product-list_block .inc_product_module_block').length
        if (INC_COL.clientConfig.slidevalueTop == -1) INC_COL.clientConfig.slidevalueTop = 0;
        var width_slide = ""
        ...
        if (INC_COL.clientConfig.slidevalueTop > 0) {
            amBlock.parentNode.parentNode.querySelector('.inc_af_right_btn_block').setAttribute("style", "pointer-events: auto;opacity:1");
            amBlock.parentNode.parentNode.querySelector('.inc_af_right_btn_img').setAttribute("style", "pointer-events: auto;opacity:1");
            INC_COL.clientConfig.slidevalueTop--
            INC_COL.clientConfig.offset = (parseInt(INC_COL.clientConfig.offset) + width_slide) + 'px';
            ...
            if (document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalueTop] != null) document.querySelectorAll('.inc_af_product-list-dots-main_block .inc_dots')[+INC_COL.clientConfig.slidevalue].classList.add('inc_active')
        }
        if (INC_COL.clientConfig.slidevalueTop == 0) {
            amBlock.parentNode.parentNode.querySelector('.inc_af_left_btn_block').setAttribute("style", "pointer-events: none;opacity:0.5");
            amBlock.parentNode.parentNode.querySelector('.inc_af_left_btn_img').setAttribute("style", "pointer-events: none;opacity:0.5");
