                        ...
                        if (pAttributes.length) {
                            for (var k = 0; k < pAttributes.length; k++) {
                                ...
                                for (var l = 0; l < pAttributesValues.length; l++) {
                                    ...
                                    // if(childProduct["quantity"] != 99999){
...
INC.methods.createPDPBlock = function (sidebar) {
    ...
    if (sidebar != "sidebar") {
        if (INC.dataStore.dataStoreObj.undefined != undefined || empty_sidebarflag == false) {
            ...
            if(pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_block.configurable .inc_product_desc_att_zero_block.inc_active') != null){
                if(pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_block.configurable .inc_product_desc_att_zero_block.inc_active .inc_product_desc_att_size_list_item_img_block') == null){
                    return;
                }
            }
            INC.methods.clear();
                    ...
                    if (prd_prc != null) {
                        ...
                        if (prd_prc != null) {
                            if (subtotalinc_active != null) {
                                ...
                                document.querySelector('.inc_cart_added_product_desc_title_text').innerHTML = qty + " X " + prdname
...
function incPriceMismatch(special_price, price, clientSpPrice, clientPrice, prdId) {
    if(price == undefined && special_price != null){
        price = special_price
    }
    if(special_price != "∞"){
        var data = {}
