...
if (window.location.host == 'www.syt03.pahtest.com') {
    INC.clientConfig.checkoutLink = "https://www.syt03.pahtest.com/shop/Basket?storeId=10151&langId=-1&catalogId=10651&krypto=auWLPddlMHb9XjSNDy%2FixFK%2BsoSLjdH8xfAgSGN1Jvw1NlOzYCOFQG05fSYjWmf1EO2gae5gIP6e%0ALoa%2FNeoWcyDh%2FloDkJKDG3233EcVLPXFeYaC1TlObvbGSc2n6dJ%2FJot09RBrwU0W6YXTgMBmYT1x%0A7dPh2UMMcIntMlelGC%2Fuq7G%2Bs0HzAVgWFVX6X1%2BD0nJ%2FPMzdVps3owQLXMF4m9AbtjlAnAklwX2g%0A50QNWiw%3D";
    INC.config.addToBasketURL = "https://www.syt03.pahtest.com/webapp/wcs/stores/servlet/AjaxOrderChangeServiceItemAdd";
    ...
    switch (INC.config.pageType) {
        case "pdp":
            ...
            setTimeout(function () {
                ...
                // }
                if (document.querySelector('.pdp-stock__message.pdp-stock__message--alert') != null) {
...
INC.dataStore.methods = function () {
    ...
    function buildDataStoreObj(bundleResponse) {
                        ...
                        if (pAttributes.length) {
                            for (var k = 0; k < pAttributes.length; k++) {
                                ...
                                for (var l = 0; l < pAttributesValues.length; l++) {
                                    ...
                                    if(childProduct["quantity"] == null){
                                        childProduct["Quantity"] = product["Quantity"];
                                    }else{
                                        childProduct["Quantity"] = childProduct["quantity"]
                                    }
                                    ...
                                    if (INC.config.recommendation == false) {
                                        ...
                                        productObj["bundledProductId"] = INC.config.Product_id
                                    }
        ...
        if (INC.config.recommendation == false) {
            ...
            incDataStore.pdpProductId = INC.config.Product_id
        }
...
INC.classes.ProductObj = function (product) {
    ...
    } else if (window.location.host == 'www.syt03.pahtest.com') {
        this.url = product["ProductUrl"].replace('https://www.petsathome.com/', 'https://www.syt03.pahtest.com/');
    } else {
    ...
    if (window.location.host == "www.uat03p.pahtest.com") {
        ...
        this.urlMain = ((product != null) && (product != undefined)) ? product["ProductUrl"].replace('https://www.petsathome.com/', 'https://www.syt03.pahtest.com/') : "";
    } else {
    ...
    if(product["ProductId"] == "14680" || product["ProductId"] == "7143429"){
        this.qty = 99999
        //product["Quantity"]
    }else{
...
INC.classes.ProductAttObj = function (product) {
    ...
    if (window.location.host == "www.uat03p.pahtest.com") {
        ...
        this.url = ((product != null) && (product != undefined)) ? product["childProductUrl"].replace('https://www.petsathome.com/', 'https://www.syt03.pahtest.com/') : "";
    } else {
        this.url = ((product != null) && (product != undefined)) ? product["childProductUrl"] : "";
    }
    ...
    if (((product != null) && (product != undefined))) {
        ...
        if(product["childProductId"] == "14680" || product["childProductId"] == "7143429" || product["childProductId"] == "7143427"){
    ...
    if (window.location.host == "www.uat03p.pahtest.com") {
        ...
        this.urlMain = ((product != null) && (product != undefined)) ? product["childProductUrlMain"].replace('https://www.petsathome.com/', 'https://www.syt03.pahtest.com/') : "";
    } else {
        this.urlMain = ((product != null) && (product != undefined)) ? product["childProductUrlMain"] : "";
    }
...
INC.methods.showSidebar = function () {
    ...
    if (document.querySelector('.inc_sidebar_modal_block') != null) {
        ...
        if (document.querySelector('.inc_sidebar_modal_block .inc_product_module_block') != null) {
            ...
            dataLayer.push({
                'event': 'vpv',
                'virtualPageURL': '/shop/bundle/confirmation/vpv',
                'virtualPageTitle': 'Bundle Confirmation VPV'
            });
...
INC.methods.hideSidebar = function () {
    ...
    var prodLength = document.querySelectorAll('.inc_af_product-list_block .inc_product_module_block').length
        if(INC.config.recommendation == true && prodLength > 5){
...
INC.methods.addProductToSidebarCart = function (findObj, qty, productBlock, client_add_btn, btn_addtocart) {
    ...
    if (document.querySelector('.inc_cart_added_product_desc_subtotal_price_block .inc_cart_added_product_desc_subtotal_price_regular_text') != null) {
        if(INC.config.recommendation == true){
            if(document.querySelector('.inc_cart_added_product_desc_subtotal_price_block .inc_cart_added_product_desc_subtotal_price_regular_text').innerText != ''){
...
INC.methods.createAMBlock = function (typepage,PDP_type,recommendation) {
    ...
    if (INC.dataStore.dataStoreObj.undefined == undefined) {
        ...
        if (PDP_type == "PDP") {
            elAmTitleText.innerText = "Best Seller in Category";
        } else if(PDP_type == "productList"){
        ...
        if (document.querySelector('.pdp-stock__message.pdp-stock__message--alert') == null) {
            if(Object.keys(bundleProductsArray).length < recload){
                return;
            }
        }
        if(Object.keys(bundleProductsArray).length < recload){
        ...
        if (PDP_type == "PDP") {
            bundleProductsArray.forEach(function (mainProductId) {
                if(duplamid.indexOf(mainProductId) == -1){
                    ...
                    var recblock=INC.methods.createProductModuleBlock(mainProductId, "am", false, amBlock)
                    if(recblock.getAttribute('data-id') != "undefined"){
                        amProductListBlock.appendChild(recblock);
        ...
        if(INC.config.recommendation == true){
            if(window.innerWidth > 768){
                if(countmodule <= 4){
                    amProductListBlock.classList.add("flexStart")
                }
            }
        ...
        Array.prototype.forEach.call(amProductBlocks, function (productBlock) {
            productBlock.querySelector(getSelectorClassName(classNames, "productAddBlock")).addEventListener("click", function (e) {
                ...
                if(INC.config.recommendation == true && productBlockNode.querySelector('.inc_product_block.simple') == null &&productBlockNode.classList.contains('simple') == false){
                    productBlockNode.querySelector('.inc_af_product-list-main_block .inc_product_img_main_img').click()
                    return;
                }
            ...
            if(window.innerWidth > 767){
                if (document.querySelector('.tabs') !=null ) {
                    ...
                    if (pdpBlockeinstienSibling != null || pdpBlockeinstienSibling != undefined) {
                        pdpBlockeinstienSibling.parentNode.insertBefore(amBlock, pdpBlockeinstienSibling);
                    }
...
INC.methods.createPDPBlock = function (sidebar) {
    ...
    if (sidebar != "sidebar") {
        if (INC.dataStore.dataStoreObj.undefined != undefined || empty_sidebarflag == false) {
            ...
            //hiding pdp when we have bundles instead of recs on client "Add for Delivery" button disabled.
            if (document.querySelector('.add-to-basket__btn-row .btn.add-to-basket__add-btn.disabled') != null) {
                pdpBlock.setAttribute('display', 'none'); 
            }
            var getSelectorClassName = INC.methods.getSelectorClassName;
            ...
            if (document.querySelector('.pdp-price .pdp-price__price') != null) {
                var activePriceCheck = document.querySelector('.pdp-price .pdp-price__price').innerText
                if (activePriceCheck.includes('-')) {
                    var activeCP = activePriceCheck.split(' ')[0].split('£')[1]
                } else {
                    var activeCP = activePriceCheck.split('£')[1]
                }
                //activeP="1.00"
            }
            if (pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_showcase_block .inc_product_desc_price_block .inc_product_desc_price_active_text')) {
                var activePriceForCheck = pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_showcase_block .inc_product_desc_price_block .inc_product_desc_price_active_text').innerText
                if (activePriceForCheck.includes('-')) {
                    var activeP = activePriceForCheck.split(' ')[0].split('£')[1]
                } else {
                    var activeP = activePriceForCheck.split('£')[1]
                }
            }
            if (document.querySelector('.pdp-price .pdp-price__was') != null) {
                var regPriceCheck = document.querySelector('.pdp-price .pdp-price__was').innerText
                if (regPriceCheck == "") {
                    var regCP = ""
                } else if (regPriceCheck.includes('-')) {
                    var regCP = regPriceCheck.split(' ')[0].split('£')[1]
                } else {
                    var regCP = regPriceCheck.split('£')[1]
                }
            }
            var regP = ""
            if (pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_showcase_block .inc_product_desc_price_block .inc_product_desc_price_regular_text')) {
                var regPriceForCheck = pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_showcase_block .inc_product_desc_price_block .inc_product_desc_price_regular_text').innerText
                if(regPriceCheck!=undefined){
                    if (regPriceCheck != "") {
                        if(typeof(regPriceForCheck) != 'undefined'){
                            if (regPriceForCheck != undefined && regPriceCheck.includes('-')) {
                                var regP = regPriceForCheck.split(' ')[0].split('£')[1]
                            } else {
                                if (regPriceForCheck != undefined) var regP = regPriceForCheck.split('£')[1]
                            }
                        }
                    } 
                }
            ...
            //activePriceCheck="1"
                ...
                if (!(pdpBlock.querySelector(".inc_product_module_block").classList.contains('configurable') && activePriceForCheck.includes('-'))) {
                    if (activePriceCheck != undefined && activePriceCheck != 0 && !(activePriceCheck.includes(activePriceForCheck))) {
                        incPriceMismatch(activeP, regP, activeCP, regCP, pdpProductId)
                        priceMismatched = true
                        return;
                    }
                    // else if(regPriceCheck!=undefined && regPriceCheck!="" && !(regPriceCheck.includes(regPriceForCheck))){
                        //     incPriceMismatch(activeP,regP,activeCP,regCP,mainProductId)
                        //     priceMismatched=true
                        //     return;
                        // }
                    }
            ...
            INC.methods.clear();
            if(pdpBlock.querySelector('.inc_pdp_product-main_block .inc_product_desc_att_size_list_item_img_block[stock="instock"]') == null){
                return
            }
                    ...
                    if (typeof (elProductAddBlock[i]) != "undefined" && i % 2 != 0) {
                        ...
                        if (window.innerWidth > 1139) {
                            if (i == 1) {
                                ...
                                if (module_block.querySelector('.inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[stock="instock"]') != null) {
                                    module_block.querySelector('.inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[stock="instock"]').click()
                                }

                                if (module_block.querySelectorAll('.inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[stock="instock"]')[0] != null) {
                                    module_block.querySelectorAll('.inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[stock="instock"]')[0].click()
                                }
                            ...
                            if (module_block.querySelectorAll('.inc_product_modal_block .inc_product_desc_att_color_list_item_img')[1] != null) {
                                module_block.querySelectorAll('.inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[stock="instock"]')[1].click()
                            } else {
            ...
            setTimeout(function () {
                ...
                if (document.querySelector('.swatch-size .swatch-element.selected input') != null) {
                    ...
                    if (document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var + '"][stock="instock"] div') != null) {
                        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var + '"][stock="instock"] div').click()
                    }
                }
                //
                var client_var1 = ""
                if (document.querySelector('.swatch-element.color.selected input') != null) {
                    ...
                    if (document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[datacolor="' + client_var1 + '"][stock="instock"] div') != undefined) {
                        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[datacolor="' + client_var1 + '"][stock="instock"] div').click()
                    }
                }
                ...
                if (document.querySelector('.variant-input-wrap[name="Type"] input[checked]') != null) {
                    ...
                    if (document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var2 + '"][stock="instock"] div') != null) {
                        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var2 + '"][stock="instock"] div').click()
                    }
                }
                if(document.querySelector('.selector__selected-value.selected') != null){
                    var client_var2 = document.querySelector('.selector__selected-value.selected').innerText.toLocaleLowerCase()
                    if (document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var2 + '"][stock="instock"] div') != null) {
                        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_size_list_item_img_block[datasize="' + client_var2 + '"][stock="instock"] div').click()
                    }
                }
...
INC.methods.updateSidebarBlock = function (mainord,qtys) {
    ...
    if (sbBlock != null) {
        ...
        if(mainord != null && mainord != undefined){
            //INC.dataStore['bundleCartProducts'] = {};
            INC.dataStore["bundleCartProducts"][mainord] = qtys; 
                        ...
                        if (dupl_sidebar_prod.indexOf(firstProductObjByMainId.id) == -1) {
                            ...
                            productBlock.querySelector(getSelectorClassName(classNames, "productAddBlock")).addEventListener("click", function (e) {
                                ...
                                if (added_maxqtyel == null) {
                                    ...
                                    } else if (productBlockNode.querySelector(getSelectorClassName(classNames, "productModalBlock")).querySelector('.inc_product_desc_att_color_list_item_img_block.avail') != null) {
                                        if (productBlockNode.querySelector(getSelectorClassName(classNames, "productModalBlock")).querySelector('.inc_product_desc_att_color_list_item_img_block.avail.inc_active') != null) {
                                            if (INC.config.disablebtn == true) {
                                                INC.config.disablebtn = false;
                            ...
                            if(productBlock.getAttribute('data-bundle_id') != 'undefined'){
...
INC.methods.createProductShowcaseBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock) {
    ...
    elvariantpopupclose.addEventListener('click', function () {
        ...
        if(INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') != null){
            document.querySelector('.inc_sidebar_modal_block.inc_active').classList.remove('Minipop_overlay');
        }
    });
    ...
    //if (INC.config.pageType == "pdp" && (INC.config.recommendation && document.querySelector('.inc_sidebar_modal_block.inc_active') == null)) {
        ...
        elImgMainImg.addEventListener("click", function (e) {
            ...
            if (INC.config.pageType == "pdp" && (INC.config.recommendation && document.querySelector('.inc_sidebar_modal_block.inc_active') == null)) {
                ...
                if (window.innerWidth < 768) {
                    ...
                    //}
                    if(INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') != null){
                        document.querySelector('.inc_sidebar_modal_block.inc_active').classList.add('Minipop_overlay')
                    }
                }
    ...
    // }else if(INC.config.pageType == "pdp" && (INC.config.recommendation && document.querySelector('.inc_sidebar_modal_block.inc_active') == null)){
    //     elTitleTextBlock.addEventListener("click", function (e) {
    //         
    //         INC.methods.sendBundleClickTracking(productBlock.getAttribute("data-main_id"));
    //         e.preventDefault(); 
    ...
    if(productObj.promoField != "" && productObj.promoField != null){
        productObj.ProductLevelDiscountMessage = productObj.promoField
    }
    if (productBlock.querySelector('.pc_promo_div') == null && productObj.ProductLevelDiscountMessage != null && productObj.ProductLevelDiscountMessage != "") {
        ...
        if(productObj.promoField != "" && productObj.promoField != undefined){
            ec_promo_div.classList.add('increas_font')
        }
    ...
    if (blockType == "am") {
        ...
        if(INC.config.recommendation == true && productObj.ProductType == "configurable" && blockType == "am"){
            productDescAddText.textContent = "More detail";
        }
    ...
    productDescAddText.parentNode.parentNode.addEventListener('click', function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                if (elQtyInput1.value == 1) {
                    ...
                    productDescQtyUp.classList.remove('incMaxqty')
                }else if(elQtyInput1.value == 100){
                    if(INC.config.recommendation == true){
                        productDescQtyUp.classList.add('incMaxqty')
    ...
    if (productColorsObj.colorArray.length > 0) {
        ...
        if (productColorsObj["colorArray"].length > 0) {
            productColorsObj["colorArray"].forEach(function (colorObj) {
                ...
                attColorImgBlock.classList.add('avail')
                if (true) {
...
INC.methods.createProductModalBlock = function (pdpProductId, blockType, bundleProductListCheck, parentblock) {
    ...
    if(INC.config.recommendation == true && productObj.ProductType == "configurable" && blockType == "am"){
        elAddText.textContent = "More detail";
    }
    elAddBlock.addEventListener("click", function () {
        if (productBlock.querySelector('.close_read_more') != null) {
            productBlock.querySelector('.close_read_more').click()
...
INC.methods.mappvariants = function (obj, blocktype, type_of_variant) {
    ...
    if (obj.parentNode != undefined) {
        ...
        if (type_of_variant == "zero" || type_of_variant == "size" || type_of_variant == "third") {
            ...
            productblockmod.querySelector('.inc_product_desc_att_color_list_item_block .inc_product_desc_att_color_list_item_img_block[datacolor="' + colorlowertext + '"]').classList.add('inc_active')
...
INC.methods.addProductToCart = function (findObj, qty, pageType, productBlock, add_btn_click, add_prod_im, btn_addtocart) {
    ...
    dojo.xhrPost({
        url: url0,
        //to be commented
        //url: "https://www.petsathome.com/error",
        ...
        load: function (_255, _256) {
            ...
            if (_255.errorMessage != undefined && _255.errorMessage != "") {
                ...
                if (INC.config.pageType == "cartPage") {
                    ...
                    if (INC.config.pageType != "pdp" && INC.config.recommendation == false) {
                ...
                if (document.querySelector('.inc_recommended_products_list_block .inc_product_module_block') == null || allprd == 1 && document.querySelector('.sidebar_outer.sidebar_outer_active') != null) {
                    ...
                    if (!INC.config.recommendation){
                        ...
                        if (INC.config.recommendation == true && document.querySelector('.sidebar_outer.sidebar_outer_active') != null) {
                            if (productBlock != null && productBlock.parentNode != null) {
                                productBlock.parentNode.removeChild(productBlock);
                            }
                        }else{
                ...
                var seidebar_pr_length = document.querySelectorAll('.inc_sidebar_modal_block .inc_product_module_block').length;
                if(document.querySelector('.sidebar_outer.sidebar_outer_active') != null){
                    if ((INC.config.pageType != "cartPage" && !INC.config.recommendation) || INC.config.pageType != "cartPage" && document.querySelector('.sidebar_outer.sidebar_outer_active') != null) {
                        if (document.querySelector('.inc_sidebar_cart_added_block') != null) {
                            document.querySelector('.inc_sidebar_cart_added_block').classList.remove('inc_active')
                        }
            ...
            //setTimeout(function(){
                if (INC.config.pageType == "pdp" && INC.config.recommendation == true) {

                    if(document.querySelector('.inc_sidebar_modal_block') != null){
                        if(document.querySelector('.sidebar_outer.sidebar_outer_active') == null){
                            INC.methods.showSidebar();
                            if(productObj.ProductType != "simple" ){
                                INC.methods.updateSidebarBlock(productObj.sku,qty);
                            }else{
                                INC.methods.updateSidebarBlock(productObj.mainId,qty);
                            }
                        }
                    }else{
                        btn_addtocart.innerText = "Add to basket"
        ...
        error: function (_25c, _25d) {
            if (document.querySelector('.inc_sidebar_modal_block.inc_active') != null) {
                //addErrorForAll(productObj.id, "Error in adding product to cart", "fromsidebar")
            } else {
               // addErrorForAll(productObj.id, "Error in adding product to cart")
            }
    ...
    if((INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') == null) && (productObj.bundleId == 'undefined' || productObj.bundleId == undefined)){
        var eventdata__ = {
        ...
        if (INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') == null) {
            pageType = "100";
        }else if(INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') != null){
            pageType = "107";
        }
...
function ajax_add_to_cart(formData, btn_cart, mainProductId, url0, url1, url2, url3, url4, url5, p0, p1, p2, p3, p4, p5) {
    ...
    function callprodA() {
        dojo.xhrPost({
            ...
            error: function (_25c, _25d) {
                if (INC.config.pageType == "pdp") {
                    addErrorForAll(mainProductId, "Error in adding Bundle to cart")
                    document.querySelector(".inc_pdp_bundle_cart_summary_add_btn_block").classList.remove("inc_loading")
                    return
                }
...
INC.methods.trackingEvents = function (eventType, eventDataObj, pageType) {
    ...
    switch (eventType) {
        ...
        case "bundleAddToCart":
            importEventDataObj["event_type"] = (INC.config.recommendation == true && (document.querySelector('.inc_sidebar_modal_block.inc_active') == null)) ? "bestseller_add_to_cart" :  "bundle_add_to_cart";
            importEventDataObj["page_type"] = pageType;
            importEventDataObj["is_logged"] = (INC.clientConfig.statusLoggedIn == true) ? "1" : "0";
            if(INC.config.recommendation == true && (document.querySelector('.inc_sidebar_modal_block.inc_active') == null)) importEventDataObj["rt"] = "8";
            importEventDataObj["method"] = "track";
            INC.methods.sendAffiliateRequest();
            break;
    }
...
function clickListener(e) {
    ...
    if (clickedElement != null) {
        ...
        try {
            ...
            if (clickedElement.className == "inc_product_block configurable show_overlay" || clickedElement.className == "inc_product_block simple show_overlay") {
                if(INC.config.recommendation == true && document.querySelector('.inc_sidebar_modal_block.inc_active') != null){
                    document.querySelector('.inc_sidebar_modal_block.inc_active').classList.remove('Minipop_overlay');
                }
            }
            ...
            if (clickedElement.parentNode != null) {
                ...
                if(clickedElement.className == 'results-view-selector__number' || clickedElement.classList.contains('results-view-selector__item') == true || clickedElement.classList.contains('pagination__link') == true || clickedElement.classList.contains('pagination__item') == true){
                    setTimeout(function(){
                        categoryCrawl();
                    },3000)
                }
            ...
            if (clickedElement.parentNode != null) {
                ...
                if (clickedElement.className == "selector__radio") {
                    ...
                    setTimeout(function () {
                        if (!((window.location.host == "www.uat03p.pahtest.com") || (window.location.host == "www.syt03.pahtest.com"))) {
                            crawl_click = true;
                            crawlscript();
                        }
                    })
                ...
                if (fieldset_variant == "Size") {
                    ...
                    client_var = sel_variant.toLowerCase();
                    if (document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[datacolor="' + client_var + '"][stock="instock"] div') != undefined) {
                        document.querySelector('.inc_pdp_product-main_block .inc_product_modal_block .inc_product_desc_att_color_list_item_img_block[datacolor="' + client_var + '"][stock="instock"] div').click()
                    }
                }
            }
            ...
            if (INC.config.pageType == "pdp") {
                if ((clickedElement.id == "add_to_cart" || clickedElement.className == "btn pdp_add_to_basket") && !(clickedElement.classList.contains('btn--repeat')) && clickedElement.parentNode.className != "click-collect__button") {
        ...
        setTimeout(function () {
            ...
            if (sbBlock != null) {
                ...
                if (findObj.sku != "" || findObj.colorText != "") {
                    ...
                    INC.methods.showSidebar();
                    if(INC.config.recommendation == true){
                        INC.methods.updateSidebarBlock(INC.dataStore.pdpProductId,qty)
                    }
                ...
                var img_elempdp = setInterval(function () {
                    ...
                    if (circle_img != null) {
                        ...
                        var regpriceel = document.querySelector('.inc_cart_added_product_desc_subtotal_price_regular_text')

                        if (prd_prc != null) {
                            
                            var subtotalinc_active = document.querySelector('.inc_cart_added_product_desc_subtotal_price_active_text');
                            //var subtotalinc_regular = document.querySelector('.inc_cart_added_product_desc_subtotal_price_regular_text');
                            ...
                            if (prd_prc != null) {
                                if (subtotalinc_active != null) {
                                    ...
                                    subtotalinc_active.setAttribute('subtotalactiveprice', subt)
                                    //regpriceel.setAttribute('subtotalregularprice', subt)
                                    //regpriceel.innerHTML = formatter.format(subt).replace('US', '')
                                    var prd_price = document.querySelector('.inc_cart_added_product_desc_price_active_text')
...
function crawlscript() {
    ...
    if (document.querySelector('#pdp-accordion__description') != null) {
        ...
        short_description = document.querySelector('#pdp-accordion__description').innerText;
    }
    if (document.querySelector('#pdp-accordion__nutrition') != null) {
        ...
        div_n.innerHTML = desc_spec
        var elnut=div_n.childNodes
        for(l=0;l<elnut.length;l++){
            if(elnut[l].classList != undefined){
                if(elnut[l].classList.contains('full-width') == true){
                   break;
                }
            }
            if(elnut[l].tagName == "SECTION"){
                break;
            }
            eldiv.appendChild(elnut[l])
        }
        
        description = desc_overview + "<span class ='inc_nutrition_text'>Nutrition & Analysis</span>" + eldiv.innerHTML;
        short_description = document.querySelector('#pdp-accordion__description').innerText + "Nutrition & Analysis" + document.querySelector('#pdp-accordion__nutrition').innerText;
    }
    if(short_description != null){
        if(short_description.length > 1250){
            short_description = short_description.substring(0,1250);
        }
    }
    // ratings and reviews
    var rating = "";
    ...
    if(document.querySelector('.pdp-stock__message.pdp-stock__message--alert') != null){
        if(document.querySelector('.pdp-stock__message.pdp-stock__message--alert').innerText != null || document.querySelector('.pdp-stock__message.pdp-stock__message--alert').innerText != ""){
            if(document.querySelector('.pdp-stock__message.pdp-stock__message--alert').innerText == 'Item is currently out of stock'){
                qty = 0;
            } 
        }
    }
    ...
    if (document.querySelector('.pdp-offer-text .pdp-offer-text__inner') != null) {
        var allprom=document.querySelectorAll('.pdp-offer-text .pdp-offer-text__inner')
        for(var p=0;p<allprom.length;p++){
            if(p == 0){
                promo = allprom[p].innerText;
            }else{
                promo = promo + "|" +allprom[p].innerText;
            }
        }
    ...
    var availability = "both"
    if((document.querySelector('.click-collect__button') != null && document.querySelector('.click-collect__button').innerText.indexOf('only available for delivery') > 0) || document.querySelector('.click-collect__button .disabled') != null) availability = "delivery only"

    var std_deliverytext = ""
    var eldelivery_mText = ""
    
    if(document.querySelector('.-js-click-free-delivery #delivery_prices_std') != null){
        std_deliverytext = document.querySelector('.-js-click-free-delivery #delivery_prices_std').innerHTML
        var deldiv_text = document.createElement('div')
        deldiv_text.innerHTML = std_deliverytext
        var del_div=document.createElement('div')
        del_div.id = 'delivery_prices_std'
        deldiv_text.appendChild(del_div)
        eldelivery_mText = deldiv_text.innerHTML
    }else if(document.querySelector('.-js-click-free-delivery #delivery_prices_spl') != null){
        std_deliverytext = document.querySelector('.-js-click-free-delivery #delivery_prices_spl').innerHTML
        var deldiv_text = document.createElement('div')
        deldiv_text.innerHTML = std_deliverytext
        var del_div=document.createElement('div')
        del_div.id = 'delivery_prices_spl'
        deldiv_text.appendChild(del_div)
        eldelivery_mText = deldiv_text.innerHTML
    }

    var click_poptext = ""
    var elclick_collect_mText = ""
    if(document.querySelector('.-js-click-collect .click-collect__content-detail') != null){
        click_poptext = document.querySelector('.-js-click-collect .click-collect__content-detail').innerHTML
    }
    
    var crawlflg=false;
    if(typeof(Captilize) != 'undefined'){
        if(Captilize != undefined){
            if(Captilize.indexOf('Please') < 0){
                crawlflg = true
            }
        }else{
            crawlflg = true
        ...
        if (crawl_click == false) {
            ...
            format_json_data = JSON.stringify({
                "event_data": {
                    ...
                    "field1": encodeURI(short_description),
                    "other_image_list": otherImageList,
                    "field2": null,
                    "field3": availability,
                    "field4": encodeURI(promo),
                    "generic_field": encodeURI(click_poptext),
                    "field5": encodeURI(eldelivery_mText),
                    "field6": field6,
                    "qty": qty
                },
...
if (onloadpdp == false && INC.methods.detectPageType() == "pdp" && !(window.location.host == "www.uat03p.pahtest.com") && !(window.location.host == 'www.syt03.pahtest.com')) {
    setTimeout(function () {
        crawlscript();
    }, 5000);
}
...
function incPriceMismatch(special_price, price, clientSpPrice, clientPrice, prdId) {
    
    var data = {}
    var priceMismatchObj = {}
    priceMismatchObj.token = INC.config.clientToken
    priceMismatchObj.product_id = prdId
    ...
    if (price == '') {
        priceMismatchObj.old_product_price = priceMismatchObj.old_special_price
        priceMismatchObj.old_special_price = null
    }
...
function addErrorForAll(prdid, error, fromSidebar) {
    ...
    error = error == null ? error = "error in methods " : error.toString()
    ...
    if (INC.config.pageType == "cartPage") {
        currentPageType = "103"
    } else if (INC.config.pageType == "pdp" && fromSidebar !== undefined) {
        currentPageType = "107"
    } else if (INC.config.pageType == "pdp") {
        currentPageType = "100"
    }
...
var final_category, final_product_ids

function categoryCrawl(){
    var productLayerprod=[];
    
    var catergory_id, product_ids;
    var empty_obj = {};

    for(l=0;l<dataLayer.length;l++){
        if(dataLayer[l].event == "productImpressions"){
            for(k=0;k<dataLayer[l].ecommerce['impressions'].length;k++){
                productLayerprod.push({
                    category:dataLayer[l].ecommerce['impressions'][k].category,
                    productList:dataLayer[l].ecommerce['impressions'][k].id
                }) 
            }
    ...
    productLayerprod.forEach(function(ele){
    ...
    if(product_arr.length>1){
        var pids = '';
        product_arr.forEach(function(ele){
            pids += ','+ ele;
        })
    ...
    if(productLayerprod.length == 0 || productLayerprod == undefined){
        ...
        var plpproductlist=[]
        var productidscategory=[]
        var productselm = document.querySelectorAll('.layout-product-tile-holder .product-tile .product-tile-basket__btn')
        var empty_obj = {};
        var catergory_id, product_ids;
        for(p=0;p<productselm.length;p++){
            var id = productselm[p].id.replace("pListBtn","")
            plpproductlist.push(id)
        }
        var product_category = [];
        var pr_cat = document.querySelectorAll('.breadcrumb__item.breadcrumb__item--show')
        for (var j = 0; j < pr_cat.length; j++) {
            if (j != 0) {
                var category_data = pr_cat[j].innerText.trim();
        ...
        productidscategory.forEach(function(ele){
            if(empty_obj[ele.category]){
                empty_obj[ele.category] += ',' +ele.productList;
            }else{
                empty_obj[ele.category] = ele.productList;
        ...
        product_ids = product_ids.filter(function(ele){
            if(ele == ''){
                return
            }else{
                return ele;
    ...
    setTimeout(function(){
        ...
        var tricrawl=false
        if (document.querySelector('.products-grid-wrap') != null || document.querySelector('.plp-wrapper') != null) {
            tricrawl = true
        } else{
        ...
        if(tricrawl == true && (final_category != undefined && final_product_ids != undefined)){
            var format_json_data;
            var product_id = final_product_ids.split(',')[0]
