    ...
    if ((window.location.hostname == "www.petsathome.com" && window.location.href.indexOf("OrderShippingBillingConfirmationView") >= 0)) {
                    ...
                    if (window.location.hostname == "www.petsathome.com" && window.location.href.indexOf("OrderShippingBillingConfirmationView") >= 0) {
                        try{
                            ...
                            if(products != undefined && products != null){  
                                ...
                                if (document.querySelector('.dth-account .dth-account__welcome') != null){
                                    if (document.querySelector('.dth-account .dth-account__welcome').innerText.indexOf("Increasingly") >= 0 || document.querySelector('.dth-account .dth-account__welcome').innerText.indexOf("Hello, Increasingly") >= 0){
                                        try{
        ...
        if(window.location.href.indexOf("shop/Checkout") == -1 && window.location.pathname != '/shop/Checkout'){
            setTimeout(function(){
                ...
                // if(document.querySelector('.dth-account__welcome')!=null){
                //     if(document.querySelector('.dth-account__welcome').innerText.includes('Increasingly')){
                //         load_script = true;
                //     }
                // }else if(document.querySelector('.account-options__heading') != null){
                //     if(document.querySelector('.account-options__heading').innerText.includes('Increasingly')){
                //         load_script = true;
                //     }

                // }
                // if(document.querySelector('.account-options__heading') != null){
                //     if(document.querySelector('.account-options__heading').innerText == "Hello, Increasingly"){
                //         load_script = true;
                //     }
                // }
                // if(document.querySelector('.account-options__heading') != null){
                //     if(document.querySelector('.account-options__heading').textContent.trim() == "Hello, Increasingly"){
                //         load_script = true;
                //     }else if(document.querySelector('.account-options__heading').textContent.indexOf('Increasingly') >= 0){
                //         load_script = true;
                //     }
                // }
                ...
                if((detectPage() == "pdp" || detectPage() == "cartPage" || detectPage() == "productList")){
                    if(load_script == true){
                        ...
                        if(document.querySelector('.account-options') != null){
                            if(document.querySelector('.account-options').textContent.indexOf('Hello, Increasingly') >= 0){
                                function addCSSFile() {
                                    var versionUpdate = (new Date()).getTime();
                                    var cssFilePath = "https://www.increasingly.co/Clients/p3ThM9/dm/css/p3ThM9.css?v=" + versionUpdate;
                                ...
                                addCSSFile()
                                var versionUpdate = (new Date()).getTime();
                                var jsFilePath = "https://www.increasingly.co/Implementation/p3ThM9/production/js/p3ThM9_org.js?v=" + versionUpdate;
                                ...
                                function addCSSFile() {
                                    var versionUpdate = (new Date()).getTime();
                                    var cssFilePath = "https://www.increasingly.co/Implementation/p3ThM9/production/css/p3ThM9.css?v=" + versionUpdate;
                                    var linkTag = document.createElement('link');
                                    linkTag.rel = "stylesheet";
                                    linkTag.href = cssFilePath;
                                    document.querySelector('head').appendChild(linkTag);
                                ...
                                addCSSFile();
                                var versionUpdate = (new Date()).getTime();
                                var jsFilePath = "https://www.increasingly.co/Implementation/p3ThM9/production/js/p3ThM9.js?v=" + versionUpdate;
                                var scriptTag = document.createElement('script');
                                scriptTag.type = 'text/javascript';
                                scriptTag.src = jsFilePath;
                                document.querySelector('body').appendChild(scriptTag);  
                            }
                        }else if (document.querySelector('.dth-account .dth-account__welcome') != null){
                            if (document.querySelector('.dth-account .dth-account__welcome').innerText.indexOf("Increasingly") >= 0 || document.querySelector('.dth-account .dth-account__welcome').innerText.indexOf("Hello, Increasingly") >= 0){
                                function addCSSFile() {
                                    var versionUpdate = (new Date()).getTime();
                                    var cssFilePath = "https://www.increasingly.co/Clients/p3ThM9/dm/css/p3ThM9.css?v=" + versionUpdate;
            ...
            setTimeout(function(){
                ...
                }else if(document.querySelector('body').innerHTML.indexOf('uat@increasingly.com') >= 0 || document.querySelector('body').innerHTML.indexOf('uat1@increasingly.com') >= 0){
                    setTimeout(function(){
                        var elmrem=document.querySelectorAll('.dth-mini-basket__items__qty-remove')
                        if(elmrem[0] != undefined){
                            for(c=0;c<elmrem.length;c++){
