...
INC.methods.detectPageType = function () {
    ...
    if (document.querySelector('.new-checkout') != null) {
        return "cartPage";
    }else if(document.querySelector('.basket-header')!=null){
        return "cartPage";
    }
    if(document.querySelector('body').classList.contains('checkout-cart-index')){
        return "cartPage";
    }
}
INC.methods.detectDeviceType = function () {
    ...
    return (window.innerWidth > 810) ? "desktop" : "mobile";
}
...
//     productBlock.parentNode.parentNode.querySelector('.inc_product_showcase_block .inc_product_qty_block').classList.add('singleqty')
    ...
    if(window.innerWidth > 820){
       ...
       jQuery('.inc_product_modal_block.inc_active .inc_product_img_gallery_list_block').animate({ scrollTop: jQuery('.inc_product_modal_block.inc_active .inc_product_img_main_block').height()}, 'fast');
       elGalleryRightArrow.style.opacity = 0.5;
       elGallerylefttArrow.style.opacity = 1;
...
if(window.innerWidth > 820){
    elGallerylefttArrow.style.opacity = 0.5;
    elGallerylefttArrow.addEventListener("click", function (e) {
    jQuery('.inc_product_modal_block.inc_active .inc_product_img_gallery_list_block').animate({ scrollTop: 0}, 'fast');
    elGallerylefttArrow.style.opacity = 0.5;
    elGalleryRightArrow.style.opacity = 1;
...
INC.methods.addProductToCart = function (findObj, qty, pageType, productBlock, add_btn_click, add_prod_im, btn_addtocart) {
    ...
    shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[0].partNumberWR, formData[0].catEntryId, "47030",formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
...
function ajax_add_to_cart(formData, btn_cart, mainProductId, url0, url1, url2, url3, url4, url5) {
    ...
    function callprodA() {
        ...
        if(document.querySelector('.dth-add-to-basket')!=null){
            document.querySelector('.dth-add-to-basket').style.visibility ='hidden';
        }

     shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[0].partNumberWR, formData[0].catEntryId, "47030",formData[0].quantity, "10151", "10651", "-1",'',successCallback);
    ...
    function callprodB() {
        ...
        shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[1].partNumberWR, formData[1].catEntryId, "47030", formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
    ...
    function callprodC() {
        ...
        shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[2].partNumberWR, formData[2].catEntryId, "47030", formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
    ...
    function callprodD() {
        ...
        shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[3].partNumberWR, formData[3].catEntryId, "47030", formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
    ...
    function callprodE() {
        ...
        shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[4].partNumberWR, formData[4].catEntryId, "47030", formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
    ...
    function callprodF() {
        ...
        shoppingActionsJS.AddItem2ShopCartAjaxWR(formData[5].partNumberWR, formData[5].catEntryId, "47030", formData[0].quantity, "10151", "10651", "-1", undefined,successCallback);
...
function inc_showSlides(n, ind, elm, type_of) {
    var i;
    //console.log(elm,"elm")
    if(elm.classList == "inc_product_modal_block inc_active"){
        elm = elm.parentNode;
    }
  ...
  // console.log(showcase_other_img_list,"showcase_other_img_list")
...
function crawlscript() {
    ...
    if (document.querySelector('.pr-category-snippet__total') != null && document.querySelector('.pr-category-snippet__total').innerText.toLowerCase() != "No Reviews".toLocaleLowerCase()) {
        review = document.querySelector('.pr-category-snippet__total').innerText;
    }
