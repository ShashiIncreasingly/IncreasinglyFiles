...
INC.methods.addBundleToCart = function(btn_cart, type_bundle) {
    ...
    Object.keys(dataStore.bundleCartProducts).forEach(function(bundleCartProduct) {
        ...
        if (type_bundle == 'delivery') {
            if (productObj.ProductType == "configurable") {
                addProductURL = addProductURL + btoa(productObj.url.split('?')[0]) + '/product/' + productObj.childsku;
                var form_param = 'product=' + productObj.childsku + '&selected_configurable_option=&related_product=&form_key=' + form_key + '&qty=' + dataStore.bundleCartProducts[bundleCartProduct] + ''
            ...
            if (productObj.ProductType == "configurable") {
                addProductURL = addProductURL + btoa(productObj.url.split('?')[0]) + '/product/' + productObj.childsku;
                var form_param = 'product=' + productObj.childsku + '&selected_configurable_option=&related_product=&form_key=' + form_key + '&qty=' + dataStore.bundleCartProducts[bundleCartProduct] + '&branchNumber=' + INC.config.storeId + '&isCollection=true'
