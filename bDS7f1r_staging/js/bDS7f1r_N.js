        ...
        if (INC.dataStore.dataStoreObj.undefined == undefined) {
            ...
            if (INC.config.pageType == "productList" && bundleProductsArray.length > 0) {
                ...
                if (window.innerWidth > 810) {
                    ...
                    // if(window.innerWidth<810){
                    //     elAMPosition = document.querySelector('.cart.table-wrapper');
                    //     elAMPosition.parentNode.insertBefore(amBlock, elAMPosition)

                    // }
                    if(document.querySelector('.cart-summary') != null){
                        document.querySelector('.cart-summary').append(amBlock)
                    }
                    else{
        ...
        elQtyDownBlock.addEventListener('click', function() {
            ...
            if (elinput.value == 1) {
                if (productBlock.parentNode.querySelector('.inc_product_desc_add_block') != null && INC.config.pageType == "pdp" && window.innerWidth > 820) {
                    productBlock.parentNode.querySelector('.inc_product_desc_add_block').click()
                }
    ...
    function clickListener(e) {
        ...
        if (clickedElement != null) {
            try {
                ...
                if (clickedElement.classList.contains('taxswitcher__indicator-show') || clickedElement.classList.contains('taxswitcher__indicator-hide')) {
